...
export declare const CreateDealPayloadSchema: Schema.Struct<{
...
export declare const CreateDealResultSchema: Schema.Struct<{
...
export declare const CreateDealValidationProblemSchema: Schema.Struct<{
...
export declare const CreateDealAuthenticationProblemSchema: Schema.Struct<{
...
export declare const CreateDealForbiddenProblemSchema: Schema.Struct<{
...
export declare const CreateDealNotFoundProblemSchema: Schema.Struct<{
...
export declare const CreateDealConflictProblemSchema: Schema.Struct<{
...
export declare const CreateDealRejectedProblemSchema: Schema.Struct<{
...
export declare const CreateDealPreconditionProblemSchema: Schema.Struct<{
...
export declare const CreateDealInternalProblemSchema: Schema.Struct<{
...
export declare const CreateDealUnavailableProblemSchema: Schema.Struct<{
...
export declare const CreateDealActionRequestHeadersSchema: Schema.Struct<{
...
declare const CreateDealSchemaErrorMiddleware_base: HttpApiMiddleware.ServiceClass<CreateDealSchemaErrorMiddleware, "crm.core/create-deal/SchemaErrorMiddleware", {
    requires: never;
    provides: never;
    error: Schema.Struct<{
        readonly _tag: Schema.tag<"CreateDealValidationProblem">;
...
export declare class CreateDealSchemaErrorMiddleware extends CreateDealSchemaErrorMiddleware_base {
}
export declare const CreateDealActionApi: HttpApi.HttpApi<"CreateDealActionApi", HttpApiGroup.HttpApiGroup<"createDealActions", HttpApiEndpoint.HttpApiEndpoint<"execute", "POST", "/actions/create-deal", HttpApiEndpoint.StringTree<never>, HttpApiEndpoint.StringTree<never>, HttpApiEndpoint.Json<Schema.Struct<{
    readonly contactId: Schema.optionalKey<Schema.NullOr<Schema.String>>;
    readonly currency: Schema.Literals<readonly ["AED", "AFN", "ALL", "AMD", "AOA", "ARS", "AUD", "AWG", "AZN", "BAM", "BBD", "BDT", "BHD", "BIF", "BMD", "BND", "BOB", "BOV", "BRL", "BSD", "BTN", "BWP", "BYN", "BZD", "CAD", "CDF", "CHE", "CHF", "CHW", "CLF", "CLP", "CNY", "COP", "COU", "CRC", "CUP", "CVE", "CZK", "DJF", "DKK", "DOP", "DZD", "EGP", "ERN", "ETB", "EUR", "FJD", "FKP", "GBP", "GEL", "GHS", "GIP", "GMD", "GNF", "GTQ", "GYD", "HKD", "HNL", "HTG", "HUF", "IDR", "ILS", "INR", "IQD", "IRR", "ISK", "JMD", "JOD", "JPY", "KES", "KGS", "KHR", "KMF", "KPW", "KRW", "KWD", "KYD", "KZT", "LAK", "LBP", "LKR", "LRD", "LSL", "LYD", "MAD", "MDL", "MGA", "MKD", "MMK", "MNT", "MOP", "MRU", "MUR", "MVR", "MWK", "MXN", "MXV", "MYR", "MZN", "NAD", "NGN", "NIO", "NOK", "NPR", "NZD", "OMR", "PAB", "PEN", "PGK", "PHP", "PKR", "PLN", "PYG", "QAR", "RON", "RSD", "RUB", "RWF", "SAR", "SBD", "SCR", "SDG", "SEK", "SGD", "SHP", "SLE", "SOS", "SRD", "SSP", "STN", "SVC", "SYP", "SZL", "THB", "TJS", "TMT", "TND", "TOP", "TRY", "TTD", "TWD", "TZS", "UAH", "UGX", "USD", "USN", "UYI", "UYU", "UYW", "UZS", "VED", "VES", "VND", "VUV", "WST", "XAD", "XAF", "XAG", "XAU", "XBA", "XBB", "XBC", "XBD", "XCD", "XCG", "XDR", "XOF", "XPD", "XPF", "XPT", "XSU", "XTS", "XUA", "XXX", "YER", "ZAR", "ZMW", "ZWG"]>;
    readonly customerId: Schema.String;
    readonly description: Schema.optionalKey<Schema.String>;
    ...
    readonly title: Schema.String;
    readonly type: Schema.String;
}>>, CreateDealSchemaErrorMiddleware, never>, false>>;
export {};
