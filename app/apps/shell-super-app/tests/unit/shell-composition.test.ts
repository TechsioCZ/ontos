...
it.effect(
  'composes one deterministic state and permission batch with lifecycle affordances',
  () =>
...
it.effect(
  'keeps healthy navigation and exposes failed installed deployments separately',
  () =>
...
it.effect(
  'normalizes number-like module order before returning the public composition',
  () =>
...
it.effect(
  'omits definite denial while preserving unavailable authorization as disabled',
  () =>
