...
automatically writable views to triggers on their base relations, follows recursive foreign-key
...
the identity can set `session_replication_role`, and matches `UPDATE OF` columns to direct or cascaded
column changes;
