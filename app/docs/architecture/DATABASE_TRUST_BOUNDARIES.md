...
view rewrite, or invocable through relation DML and an enabled user trigger, following accessible
partition ancestors when rows route to leaf triggers and matching `UPDATE OF` columns to column
grants; inventories extension and foreign-server ownership and user-defined base,
