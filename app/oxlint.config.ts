...
const effectNativeRules: NonNullable<Parameters<typeof defineConfig>[0]['rules']> = {
  ...
  'effect-native/no-async-script-program': 'error',
  'effect-native/no-bare-effect-run': 'error',
  'effect-native/no-console-in-scripts': 'error',
  ...
  'effect-native/no-failure-discarding-error-callback': 'error',
  'effect-native/no-hand-built-http-server-in-tests': 'error',
  'effect-native/no-hand-built-problem-details': 'error',
  'effect-native/no-hand-parsed-environment-value': 'error',
  'effect-native/no-hand-rolled-tagged-union': 'error',
  'effect-native/no-imperative-loop-in-effect-gen': 'error',
  'effect-native/no-interface-first-codec': 'error',
  'effect-native/no-json-schema-as-document-contract': 'error',
  'effect-native/no-layer-fresh': 'error',
  ...
  'effect-native/no-native-timers': 'error',
  'effect-native/no-nested-effect-run': 'error',
  'effect-native/no-nullable-schema-field': 'error',
  'effect-native/no-nullable-service-outcome': 'error',
  'effect-native/no-per-operation-http-api-client': 'error',
  'effect-native/no-per-request-key-material': 'error',
  'effect-native/no-process-exit-outside-script-entry': 'error',
  'effect-native/no-promise-first-scaffold-templates': 'error',
  'effect-native/no-promise-shaped-port': 'error',
  'effect-native/no-raw-effect-adt-tag-check': 'error',
  'effect-native/no-refinement-outside-schema': 'error',
  'effect-native/no-route-local-error-classifier': 'error',
  'effect-native/no-runtime-construction-outside-root': 'error',
  'effect-native/no-scattered-browser-effect-run': 'error',
  'effect-native/no-sequential-independent-yields': 'error',
  'effect-native/no-string-timestamp-schema': 'error',
  'effect-native/no-structural-document-walking': 'error',
  'effect-native/no-symbol-slotted-operation-record': 'error',
  'effect-native/no-sync-schema-codec': 'error',
  'effect-native/no-threaded-correlation-parameter': 'error',
  'effect-native/no-throw-in-configuration-parser': 'error',
  'effect-native/no-throw-in-effect-callback': 'error',
  'effect-native/no-throw-in-scripts': 'error',
  'effect-native/no-unbranded-identifier-schema': 'error',
  'effect-native/no-unjustified-file-wide-lint-suppression': 'error',
  'effect-native/no-unmanaged-mutable-state': 'error',
  'effect-native/no-unredacted-secret-field': 'error',
  'effect-native/no-wide-factory-signature': 'error',
  'effect-native/prefer-effect-fn-for-operations': 'error',
  'effect-native/prefer-match-over-tag-switch': 'error',
  'effect-native/require-concurrency-option': 'error',
  'effect-native/require-context-service-for-service-interface': 'error',
  'effect-native/require-observability-layers-at-runtime-root': 'error',
  'effect-native/require-timeout-on-external-effect': 'error',
} as const;
...
export default defineConfig({
  ...
  overrides: [
    {
      // Sonar S2187 has a hard-coded API list excluding Effect's it.effect/it.live/it.layer.
      // Keep scoped to verified pilot files until the upstream detector supports these APIs.
      files: [
        'packages/core-runtime/tests/unit/outbox-definition.test.ts',
        'packages/core-runtime/tests/integration/outbox-runtime.test.ts',
        'verticals/party-registry/tests/unit/api-integration-ares-application.test.ts',
        'apps/shell-super-app/tests/unit/auth-config.test.ts',
        'apps/shell-super-app/tests/unit/stage-demo-bootstrap.test.ts',
      ],
      rules: { 'sonarjs/no-empty-test-file': 'off' },
    },
    {
      // These native Promise APIs are lifted directly into Effect; async thunks add no behavior.
      files: [
        'packages/core-runtime/tests/integration/outbox-runtime.test.ts',
        'apps/shell-super-app/tests/unit/stage-demo-bootstrap.test.ts',
      ],
    ...
    {
      // vendored port of @effect/vitest; keep diffable against upstream
      files: ['packages/effect-rstest/src/**'],
      rules: {
        ...
        'effect-native/no-bare-effect-run': 'off',
        'effect-native/no-dependency-parameters': 'off',
        'effect-native/no-effect-provide-in-library': 'off',
        'effect-native/no-imperative-loop-in-effect-gen': 'off',
        'effect-native/no-layer-provide-in-library': 'off',
        'effect-native/no-local-defect-seam': 'off',
        'effect-native/no-native-error-construction': 'off',
        'effect-native/no-nested-effect-run': 'off',
        'effect-native/no-promise-shaped-port': 'off',
        'effect-native/no-refinement-outside-schema': 'off',
