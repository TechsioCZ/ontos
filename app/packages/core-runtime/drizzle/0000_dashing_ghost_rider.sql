...
CREATE TABLE "core"."action_invocations" (
	...
	CONSTRAINT "core_action_invocations_auth_method_ck" CHECK ("core"."action_invocations"."auth_method" is null or "core"."action_invocations"."auth_method" in ('session', 'api_key', 'system', 'support_impersonation')),
	CONSTRAINT "core_action_invocations_status_ck" CHECK ("core"."action_invocations"."status" in ('received', 'rejected', 'running', 'succeeded', 'failed', 'indeterminate', 'replayed'))
);
--> statement-breakpoint
