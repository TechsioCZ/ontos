...
// Each object ID encodes the stable permission code and exact tenant/legal-entity/business scope.
// Grants are positive and exact; tenant membership and Legal Entity access remain independent gates.
definition business_permission {
  relation legal_entity: legal_entity
  relation grantee: principal
  permission use = grantee & legal_entity->access
}
