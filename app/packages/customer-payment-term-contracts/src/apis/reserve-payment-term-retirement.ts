...
const BoundedReasonSchema = Schema.String.check(
...
export const ReservePaymentTermRetirementUnavailableProblemSchema =
  makeRetryableProblemDetailsSchema('ReservePaymentTermRetirementUnavailableProblem', 503);
