// oxlint-disable effect-native/no-native-timers -- real runner hook deadlines cannot be driven by TestClock; remove-when: Rstest exposes controllable hook timers
import { describe, expect, it, layer } from '@app/effect-rstest';
