...
it.live(
  'assembles a concrete API with caller-provided handler dependencies',
  () =>
...
it.live(
  'keeps an optional caller-owned CORS layer in the assembled runtime',
  () =>
...
it.live(
  'keeps strict runtime defect handling at the generated HTTP boundary',
  () =>
