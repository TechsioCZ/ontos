...
`,
  ...
  permission: defineCommand({
    ...
    help: `Usage: pnpm scaffold:permission -- --vertical <vertical> --permission <retail.*|counterparty.*|inventory.*|pricing.price_group.*> --scope <retail_profile|counterparty|counterparty_storefront|inventory_resource|pricing_catalog|price_group>
...
Required flags:
  --vertical <vertical>  Existing generated vertical folder (lower-kebab-case)
  --permission <code>    Stable lowercase retail.*, counterparty.*, inventory.*, or pricing.price_group.* Permission code
      ...
      Effect.gen(function* permissionConfigEffect() {
        ...
        if (
          ...
          return yield* failScaffolding(
            '--scope must be retail_profile, counterparty, counterparty_storefront, inventory_resource, pricing_catalog, or price_group',
          );
        }
        return {
          permission: flags.permission ?? '',
