...
void test('governed generators reject legacy principal boundaries before writing files', async () => {
  await withFixture(async (fixture) => {
    await addInventoryItemResourceType(fixture);
    await run(fixture, scaffoldCommand.microverticalActionBoundary, [
      scaffoldFlag.vertical,
...
void test('governed generation preserves compatible owner principal adaptations', async () => {
  await withFixture(async (fixture) => {
    await run(fixture, scaffoldCommand.microverticalActionBoundary, [
      scaffoldFlag.vertical,
      inventorySlug,
