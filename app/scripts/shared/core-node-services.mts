...
export const loadCoreNodeServices = () => {
  ...
  const NodeServicesLayerSchema = Schema.declare<
    Layer.Layer<Command.Environment>
  >((value): value is Layer.Layer<Command.Environment> =>
    Schema.is(AnyLayerSchema)(value)
  );
