...
void test('allows owner database factories and rejects Action, read, nested BFF, and hidden Core database bypasses deterministically', async () => {
  ...
  try {
    const files = {
      ...
      'verticals/stock/src/reads/list.read.ts':
