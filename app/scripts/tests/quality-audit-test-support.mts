...
export const runPinnedKnip = Effect.fn('runPinnedKnip')(function* runPinnedKnipEffect(
  root: string,
  consumerPath: string,
  model: {
  ...
  const configuration = yield* Schema.encodeEffect(Schema.fromJsonString(KnipConfigSchema))(model.config);
