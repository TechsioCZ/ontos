...
const workspaceValidationContract = {
  ...
  cohort: {
    ...
    appIds: ['shell-super-app', 'projects'],
    backendAppIds: ['projects'],
    verticalIds: ['projects'],
  ...
  topology: {
    compactConfig: {
      ...
      apps: [
        ...
        },
        {
          ...
          packageSuffix: 'projects',
          displayName: 'Projects Vertical',
          path: 'verticals/projects',
          domain: 'projects',
          port: 4101,
          portEnv: 'VERTICAL_PROJECTS_PORT',
          moduleFederation: {
            role: 'remote',
            name: 'verticalProjects',
            exposes: ['./PageProjects'],
            ssr: true,
            dts: {
              compilerInstance: 'effect-tsgo',
              tsConfigPath: './tsconfig.mf-types.json',
          ...
          backendFederation: {
            ...
            versionBoundary: {
              ...
              ui: {
                manifestEnv: 'VERTICAL_PROJECTS_MF_MANIFEST',
                manifestUrl: 'http://localhost:4101/mf-manifest.json',
                buildMarker: 'verticals/projects/src/routes/ultramodern-route-metadata.ts',
              },
              api: {
                readiness: '/projects-api/projects/readiness',
                buildMarker: 'verticals/projects/shared/ultramodern-build.ts',
            ...
            executionSurfaces: {
              cloudflare: {
                ...
                zephyr: {
                  ...
                  snapshotIdEnv: 'ZEPHYR_PROJECTS_SNAPSHOT_ID',
                  versionIdEnv: 'ZEPHYR_PROJECTS_VERSION_ID',
                  applicationUidEnv: 'ZEPHYR_PROJECTS_APPLICATION_UID',
                },
                workerDispatch: {
                  preferred: 'service-binding',
                  serviceBinding: 'VERTICAL_PROJECTS_WORKER',
                  serviceBindingEnv: 'VERTICAL_PROJECTS_WORKER_BINDING',
                  dispatchNamespaceEnv: 'VERTICAL_PROJECTS_DISPATCH_NAMESPACE',
                  dispatchWorkerNameEnv: 'VERTICAL_PROJECTS_WORKER_NAME',
          ...
          deploy: {
            cloudflare: {
              ...
              routes: {
                ssr: '/en',
                mfManifest: '/mf-manifest.json',
                locale: '/locales/en/projects.json',
    ...
    developmentOverlay: {
      ...
      manifests: {
        projects: 'http://localhost:4101/mf-manifest.json',
      },
      ontosModuleManifests: {
        projects: 'http://localhost:4101/.well-known/ontos-module-manifest.json',
      },
      serverExecution: {
        projects: {
          apiBaseUrl: 'http://localhost:4101/projects-api',
      ...
      apis: {
        projects: 'http://localhost:4101/projects-api',
      },
    },
  },
  policy: {
    ...
    rules: [
      {
        ...
        paths: [
          ...
          {
            kind: 'directory',
            path: 'verticals/projects/src',
            extensions: ['.ts', '.tsx'],
          },
          {
            kind: 'directory',
            path: 'verticals/projects/api',
            extensions: ['.ts', '.tsx'],
          },
          {
            kind: 'directory',
          ...
          {
            kind: 'file',
            path: 'verticals/projects/modern.config.ts',
          },
          {
            kind: 'file',
          ...
          {
            kind: 'file',
            path: 'verticals/projects/module-federation.config.ts',
          },
        ],
        patterns: [
          {
  ...
  fullStackVerticals: [
    {
      ...
      exposes: ['./PageProjects'],
      componentPaths: ['verticals/projects/src/federation/page-projects.tsx'],
      typecheckIncludes: [
        'src',
        'scripts',
        'tests',
      ...
      namespace: 'projects',
      routePagePaths: [],
      routeMetaPaths: ['verticals/projects/src/routes/[lang]/route.meta.ts'],
      localisedUrls: {},
      verticalRefs: [],
    },
  ],
  ...
  packageScripts: {
    ...
    'db:generate':
      'pnpm --filter @app/core-runtime db:generate && pnpm --filter @app/shell-super-app db:generate && pnpm --filter @app/projects db:generate',
    ...
    'db:test':
      'pnpm --filter @app/core-runtime db:test && pnpm --filter @app/shell-super-app test:integration && pnpm --filter @app/projects db:test',
...
if (process.platform !== 'win32') {
  const projectsRequire = createRequire(path.join(root, 'verticals/projects/package.json'));
  const appToolsRequire = createRequire(projectsRequire.resolve('@modern-js/app-tools'));
