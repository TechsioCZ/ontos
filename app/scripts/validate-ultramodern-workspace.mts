      ...
      apps: [
        ...
        },
        {
          ...
          moduleFederation: {
            role: 'remote',
            name: 'verticalCrm',
            exposes: ['./PageCustomers', './PageDeals'],
            ssr: true,
            dts: {
              compilerInstance: 'effect-tsgo',
              tsConfigPath: './tsconfig.mf-types.json',
    ...
    rules: [
      {
        ...
        paths: [
          ...
          },
          {
            ...
            extensions: ['.ts', '.tsx'],
            excludePaths: ['verticals/crm/src/db/config.ts'],
          },
          {
            kind: 'directory',
  ...
  fullStackVerticals: [
    {
      ...
      apiPrefix: '/crm-api',
      apiProtocol: 'rest',
      apiContractExport: undefined,
      apiClientExport: undefined,
      ...
      exposes: ['./PageCustomers', './PageDeals'],
      componentPaths: [
        'verticals/crm/src/routes/[lang]/customers/page.tsx',
        'verticals/crm/src/routes/[lang]/deals/page.tsx',
      ],
      namespace: 'crm',
      routePagePaths: [],
