...
- [x] Run `mise exec -- pnpm --filter @app/crm add --save-dev @modern-js/adapter-rstest@npm:@bleedingdev/modern-js-adapter-rstest@3.8.2-ultramodern.12 @rstest/core@0.11.10 @testing-library/dom@10.4.1 @testing-library/react@16.3.2 @testing-library/user-event@14.6.1 happy-dom@20.8.3`, create `modern.rstest.config.ts` / `rstest.config.ts`, and add a `test:component` script without replacing the existing Node unit/integration scripts.
