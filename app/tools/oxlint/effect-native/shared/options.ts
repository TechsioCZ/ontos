...
export function stringArray(value: unknown, fallback: readonly string[]): readonly string[] {
...
export function safeRegExp(source: string, fallback: string, flags = 'u'): RegExp {
...
export function compilePatterns(sources: readonly string[], flags = 'gu'): readonly RegExp[] {
  return sources.map((source) => tryRegExp(source, flags)).filter((pattern) => pattern !== null);
}
