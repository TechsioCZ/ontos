...
export const backendFederationContract = {
  ...
  openapiPath: '/catalog-api/openapi.json',
...
export { catalogApiContract as contract, catalogOperationContexts as operationContexts } from '../shared/api.ts';
export const api: unknown = catalogApi;
