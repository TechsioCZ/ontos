...
import { mapCreateProductTypeActionProblem } from '../../api/create-product-type-action-problems.ts';

const invocationId = '33333333-3333-4333-8333-333333333333';

describe('create-product-type recovery direction', () => {
  it('directs a committed retry to its exact typed recovery read', () => {
    const problem = mapCreateProductTypeActionProblem(
