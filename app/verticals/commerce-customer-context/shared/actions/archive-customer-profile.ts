...
export const ArchiveCustomerProfilePayloadSchema = Schema.Struct({
...
export type ArchiveCustomerProfilePayload = typeof ArchiveCustomerProfilePayloadSchema.Type;

export const ArchiveCustomerProfileResultSchema = Schema.Struct({
  effectiveAt: ProfileInstantSchema,
...
export type ArchiveCustomerProfileResult = typeof ArchiveCustomerProfileResultSchema.Type;
