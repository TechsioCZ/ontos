...
export type RevokeCounterpartyAccessInvitationPayload =
  typeof RevokeCounterpartyAccessInvitationPayloadSchema.Type;
...
export type RevokeCounterpartyAccessInvitationResult =
  typeof RevokeCounterpartyAccessInvitationResultSchema.Type;
