...
export const RevokeRetailPortalProfileBindingPayloadSchema = Schema.Struct({
...
export type RevokeRetailPortalProfileBindingPayload =
  typeof RevokeRetailPortalProfileBindingPayloadSchema.Type;

export const RevokeRetailPortalProfileBindingResultSchema = RetailPortalBindingResultSchema;
export type RevokeRetailPortalProfileBindingResult =
  typeof RevokeRetailPortalProfileBindingResultSchema.Type;
