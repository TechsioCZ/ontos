...
export class AddressBookUnavailable extends Schema.TaggedError<AddressBookUnavailable>()('AddressBookUnavailable', {
...
const SavedAddressNotFoundSchema = Schema.TaggedStruct('SavedAddressNotFound', {
...
const SavedAddressReconciliationRequiredSchema = Schema.TaggedStruct('SavedAddressReconciliationRequired', {
  code: Schema.Literal('saved_address_reconciliation_required'),
  reason: Schema.String,
});
const SavedAddressSourceTransitionRequiredSchema = Schema.TaggedStruct('SavedAddressSourceTransitionRequired', {
