...
export const CustomerGroupPersistenceUnavailable = Schema.TaggedError<typeof PersistenceUnavailableSchema.Type>()(
  'CustomerGroupPersistenceUnavailable',
  persistenceUnavailableFields,
);
export type CustomerGroupPersistenceUnavailableError = InstanceType<typeof CustomerGroupPersistenceUnavailable>;
...
const ProfileNotFoundSchema = Schema.TaggedStruct('CustomerGroupProfileNotFound', profileNotFoundFields);
...
const BusinessCodeConflictSchema = Schema.TaggedStruct('CustomerGroupBusinessCodeConflict', businessCodeConflictFields);
export const CustomerGroupBusinessCodeConflict = Schema.TaggedError<typeof BusinessCodeConflictSchema.Type>()(
...
const SemanticDuplicateSchema = Schema.TaggedStruct('CustomerGroupSemanticDuplicate', semanticDuplicateFields);
export const CustomerGroupSemanticDuplicate = Schema.TaggedError<typeof SemanticDuplicateSchema.Type>()(
...
const RevisionConflictSchema = Schema.TaggedStruct('CustomerGroupRevisionConflict', revisionConflictFields);
export const CustomerGroupRevisionConflict = Schema.TaggedError<typeof RevisionConflictSchema.Type>()(
  'CustomerGroupRevisionConflict',
  revisionConflictFields,
);

const definitionChangeRequiresNewGroupFields = codedReason('customer_group_definition_change_requires_new_group');
...
const archivedCorrectionForbiddenFields = codedReason('customer_group_archived_correction_forbidden');
...
const LifecycleConflictSchema = Schema.TaggedStruct('CustomerGroupLifecycleConflict', lifecycleConflictFields);
export const CustomerGroupLifecycleConflict = Schema.TaggedError<typeof LifecycleConflictSchema.Type>()(
...
const ProfileIneligibleSchema = Schema.TaggedStruct('CustomerGroupProfileIneligible', profileIneligibleFields);
export const CustomerGroupProfileIneligible = Schema.TaggedError<typeof ProfileIneligibleSchema.Type>()(
...
const MembershipOverlapSchema = Schema.TaggedStruct('CustomerGroupMembershipOverlap', membershipOverlapFields);
export const CustomerGroupMembershipOverlap = Schema.TaggedError<typeof MembershipOverlapSchema.Type>()(
...
const MembershipNotFoundSchema = Schema.TaggedStruct('CustomerGroupMembershipNotFound', membershipNotFoundFields);
export const CustomerGroupMembershipNotFound = Schema.TaggedError<typeof MembershipNotFoundSchema.Type>()(
...
export const CustomerGroupMembershipRemovalConflict = Schema.TaggedError<typeof MembershipRemovalConflictSchema.Type>()(
  'CustomerGroupMembershipRemovalConflict',
  membershipRemovalConflictFields,
);
