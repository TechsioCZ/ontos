...
import type { CounterpartyPermissionScope, CounterpartyRef, PrincipalRef } from './access-contract.ts';
...
import type { InvitationClaimProofReference, VerifiedInvitationClaimAttestation } from './invitation-contract.ts';
