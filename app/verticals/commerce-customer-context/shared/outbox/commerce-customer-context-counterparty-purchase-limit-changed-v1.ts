...
// @ontos-outbox-topic commerce.customer-context.counterparty-purchase-limit-changed.v1
import { CounterpartyPurchaseLimitChangedEventSchema } from '../domain/purchase-limit-policy.ts';
