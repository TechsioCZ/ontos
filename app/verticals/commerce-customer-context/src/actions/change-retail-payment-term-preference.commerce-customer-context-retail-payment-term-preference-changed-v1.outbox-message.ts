...
export type ChangeRetailPaymentTermPreferenceCommerceCustomerContextRetailPaymentTermPreferenceChangedV1OutboxPayload =
  OutboxPayload;
const ChangeRetailPaymentTermPreferenceCommerceCustomerContextRetailPaymentTermPreferenceChangedV1OutboxProducerModuleKey =
  outboxProducerModuleKey;
const ChangeRetailPaymentTermPreferenceCommerceCustomerContextRetailPaymentTermPreferenceChangedV1OutboxTopic =
  outboxTopic;
...
export const createChangeRetailPaymentTermPreferenceCommerceCustomerContextRetailPaymentTermPreferenceChangedV1OutboxMessage =
  (payload: OutboxPayload): OutboxMessage => ({
    ...
    topic: ChangeRetailPaymentTermPreferenceCommerceCustomerContextRetailPaymentTermPreferenceChangedV1OutboxTopic,
  });
