...
export const RevokeCounterpartyAccessInvitationCommerceCustomerContextCounterpartyAccessInvitationRevokedV1OutboxPayloadSchema =
  OutboxPayloadSchema;
const RevokeCounterpartyAccessInvitationCommerceCustomerContextCounterpartyAccessInvitationRevokedV1OutboxProducerModuleKey =
  outboxProducerModuleKey;
const RevokeCounterpartyAccessInvitationCommerceCustomerContextCounterpartyAccessInvitationRevokedV1OutboxTopic =
  outboxTopic;
...
export const createRevokeCounterpartyAccessInvitationCommerceCustomerContextCounterpartyAccessInvitationRevokedV1OutboxMessage =
  (payload: OutboxPayload): OutboxMessage => ({
    ...
    topic: RevokeCounterpartyAccessInvitationCommerceCustomerContextCounterpartyAccessInvitationRevokedV1OutboxTopic,
  });
