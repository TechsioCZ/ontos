...
export interface ReactivateCustomerGroupActionClientOptions {
...
type AuthorizedInvocation = readonly [
  ...
  options: ReactivateCustomerGroupActionClientOptions,
];
type OperationInvocation = readonly [requestCorrelation: string, options: ReactivateCustomerGroupActionClientOptions];

interface MakeClientOptions {
  readonly credential: Redacted.Redacted;
  readonly options: ReactivateCustomerGroupActionClientOptions;
...
export const executeReactivateCustomerGroupWithAuthorization = (
...
export const executeReactivateCustomerGroup = (
  payload: ReactivateCustomerGroupPayload,
  ...[requestCorrelation, options]: OperationInvocation
) =>
  operationGateway.invoke(
    (credential) => executeReactivateCustomerGroupWithAuthorization(payload, credential, requestCorrelation, options),
    options.gateway,
  );
