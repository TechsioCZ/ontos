...
export const resolveCommerceFxShellOrigin = (value?: string): string =>
  value !== undefined && value.trim().length > 0 ? value : DEFAULT_SHELL_ORIGIN;

export const commerceFxCorsAllowedHeaders = [
  'Accept',
  'Accept-Language',
  'Authorization',
  'B3',
...
export const commerceFxCorsAllowedMethods = ['GET', 'HEAD', 'OPTIONS', 'POST'] as const;

export const commerceFxCorsAllowedOrigins = (configuredOrigin: string): readonly string[] => {
