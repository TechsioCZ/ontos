ALTER TABLE "commerce_market_catalog"."market_lifecycle_periods" ADD COLUMN "retirement_impact_assessment" jsonb;
...
begin
  ...
  if v_target = 'RETIRED' and (
       ...
       or nullif(btrim(v_retirement_impact->>'reservationToken'), '') is null
