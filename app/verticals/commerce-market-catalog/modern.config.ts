  ...
  presetUltramodern(
    {
      ...
      tools: {
        ...
        bundlerChain: (chain) => {
          chain.output
            .uniqueName('verticalCommerceMarketCatalog')
            .chunkLoadingGlobal('__ULTRAMODERN_VERTICAL_COMMERCE_MARKET_CATALOG_LOADED_CHUNKS__');
        },
    ...
    } satisfies AppToolsUserConfig,
    {
      ...
      deliveryUnit: {
        ...
        unitId: 'app/commerce-market-catalog',
        version: '0.1.0',
      },
    },
  ),
