...
export const AresIcoSchema = ContactsIcoSchema;
...
const AresRawSubjectSchema = Schema.Struct({
  ...
  dic: Schema.optional(Schema.NullOr(ContactsDicSchema)),
  ico: AresIcoSchema,
  obchodniJmeno: ContactsPersistedTextSchema,
  pravniForma: Schema.optional(Schema.NullOr(ContactsLegalFormCodeSchema)),
});
...
>()('@app/contacts/integrations/ares/ares-subject.service/AresSubjectService') {}
