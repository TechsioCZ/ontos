...
export const contactDetailHref = (language: string, customerId: string, contactId: string) =>
  `/${language}/contacts/customers/${customerId}/contacts/${contactId}`;
...
export const ContactEditFeature = ({ routeParams, target }: ContactEditPageProps) => {
  ...
  const copy: ContactEditCopy = {
    back: t('contacts.pages.contactEdit.back'),
    description: t('contacts.pages.contactEdit.description'),
    form: {
      cancel: t('contacts.pages.contactEdit.form.cancel'),
      emailInvalid: t('contacts.pages.contactEdit.form.emailInvalid'),
      emailLabel: t('contacts.pages.contactEdit.form.emailLabel'),
      emailRequired: t('contacts.pages.contactEdit.form.emailRequired'),
      nameInvalid: t('contacts.pages.contactEdit.form.nameInvalid'),
      nameLabel: t('contacts.pages.contactEdit.form.nameLabel'),
      nameRequired: t('contacts.pages.contactEdit.form.nameRequired'),
      phoneCountryLabel: t('contacts.pages.contactEdit.form.phoneCountryLabel'),
      phoneInvalid: t('contacts.pages.contactEdit.form.phoneInvalid'),
      phoneLabel: t('contacts.pages.contactEdit.form.phoneLabel'),
      phonePlaceholder: t('contacts.pages.contactEdit.form.phonePlaceholder'),
      phoneRequired: t('contacts.pages.contactEdit.form.phoneRequired'),
      submit: t('contacts.pages.contactEdit.form.submit'),
      submitting: t('contacts.pages.contactEdit.form.submitting'),
    },
    mutation: {
      authenticationExpired: t('contacts.pages.contactEdit.mutation.authenticationExpired'),
      conflict: t('contacts.pages.contactEdit.mutation.conflict'),
      decode: t('contacts.pages.contactEdit.mutation.decode'),
      forbidden: t('contacts.pages.contactEdit.mutation.forbidden'),
      generic: t('contacts.pages.contactEdit.mutation.generic'),
      invalidForm: t('contacts.pages.contactEdit.mutation.invalidForm'),
      notFound: t('contacts.pages.contactEdit.mutation.notFound'),
      success: t('contacts.pages.contactEdit.mutation.success'),
      transport: t('contacts.pages.contactEdit.mutation.transport'),
      unavailable: t('contacts.pages.contactEdit.mutation.unavailable'),
    },
    states: {
      authenticationExpired: t('contacts.pages.contactEdit.states.authenticationExpired'),
      decode: t('contacts.pages.contactEdit.states.decode'),
      forbidden: t('contacts.pages.contactEdit.states.forbidden'),
      generic: t('contacts.pages.contactEdit.states.generic'),
      invalidTarget: t('contacts.pages.contactEdit.states.invalidTarget'),
      loading: t('contacts.pages.contactEdit.states.loading'),
      notFound: t('contacts.pages.contactEdit.states.notFound'),
      readOnly: t('contacts.pages.contactEdit.states.readOnly'),
      retry: t('contacts.pages.contactEdit.states.retry'),
      retrying: t('contacts.pages.contactEdit.states.retrying'),
      transport: t('contacts.pages.contactEdit.states.transport'),
      unavailable: t('contacts.pages.contactEdit.states.unavailable'),
    },
    title: t('contacts.pages.contactEdit.title'),
  };
  ...
  if (decodedRoute === undefined) {
    return (
      <section
        aria-labelledby="contact-edit-heading"
  ...
  if (detailQuery.isPending) {
    ...
    content = (
      <div className="contacts:grid contacts:min-w-0 contacts:gap-5">
...
export const ContactEditPage = ({ routeParams, target }: ContactEditPageProps) => {
  const queryClient = useMemo(() => getContactsQueryClient(), []);
