...
export const classifyEditCustomerError = (
  ...
  switch (error._tag) {
    ...
    case 'ContactsConflictProblem': {
      return error.code === 'contacts_customer_ico_conflict'
        ? { state: 'ico_conflict' }
        : { state: 'conflict' };
    }
...
export const decodeCustomerEditId = (routeParams: CustomerEditPageRouteParams) => {
  const decoded = Schema.decodeUnknownOption(ContactsUuidSchema)(routeParams.id);
...
export const CustomerEditFeature = ({ routeParams, target }: CustomerEditPageProps) => {
  ...
  const copy: CustomerEditCopy = {
    back: t('contacts.pages.customerEdit.back'),
    description: t('contacts.pages.customerEdit.description'),
    form: {
      cancel: t('contacts.pages.customerEdit.form.cancel'),
      dicHint: t('contacts.pages.customerEdit.form.dicHint'),
      dicInvalid: t('contacts.pages.customerEdit.form.dicInvalid'),
      dicLabel: t('contacts.pages.customerEdit.form.dicLabel'),
      dissolvedBeforeEstablished: t('contacts.pages.customerEdit.form.dissolvedBeforeEstablished'),
      dissolvedOnHint: t('contacts.pages.customerEdit.form.dissolvedOnHint'),
      dissolvedOnLabel: t('contacts.pages.customerEdit.form.dissolvedOnLabel'),
      establishedOnHint: t('contacts.pages.customerEdit.form.establishedOnHint'),
      establishedOnLabel: t('contacts.pages.customerEdit.form.establishedOnLabel'),
      icoHint: t('contacts.pages.customerEdit.form.icoHint'),
      icoInvalid: t('contacts.pages.customerEdit.form.icoInvalid'),
      icoLabel: t('contacts.pages.customerEdit.form.icoLabel'),
      legalFormCodeHint: t('contacts.pages.customerEdit.form.legalFormCodeHint'),
      legalFormCodeInvalid: t('contacts.pages.customerEdit.form.legalFormCodeInvalid'),
      legalFormCodeLabel: t('contacts.pages.customerEdit.form.legalFormCodeLabel'),
      nameHint: t('contacts.pages.customerEdit.form.nameHint'),
      nameInvalid: t('contacts.pages.customerEdit.form.nameInvalid'),
      nameLabel: t('contacts.pages.customerEdit.form.nameLabel'),
      nameRequired: t('contacts.pages.customerEdit.form.nameRequired'),
      save: t('contacts.pages.customerEdit.form.save'),
      saving: t('contacts.pages.customerEdit.form.saving'),
    },
    mutation: {
      authenticationExpired: t('contacts.pages.customerEdit.mutation.authenticationExpired'),
      conflict: t('contacts.pages.customerEdit.mutation.conflict'),
      duplicateIco: t('contacts.pages.customerEdit.mutation.duplicateIco'),
      forbidden: t('contacts.pages.customerEdit.mutation.forbidden'),
      generic: t('contacts.pages.customerEdit.mutation.generic'),
      invalid: t('contacts.pages.customerEdit.mutation.invalid'),
      notFound: t('contacts.pages.customerEdit.mutation.notFound'),
      success: t('contacts.pages.customerEdit.mutation.success'),
    },
    states: {
      authenticationExpired: t('contacts.pages.customerEdit.states.authenticationExpired'),
      decode: t('contacts.pages.customerEdit.states.decode'),
      forbidden: t('contacts.pages.customerEdit.states.forbidden'),
      generic: t('contacts.pages.customerEdit.states.generic'),
      loading: t('contacts.pages.customerEdit.states.loading'),
      notFound: t('contacts.pages.customerEdit.states.notFound'),
      readOnly: t('contacts.pages.customerEdit.states.readOnly'),
      retry: t('contacts.pages.customerEdit.states.retry'),
      retrying: t('contacts.pages.customerEdit.states.retrying'),
      transport: t('contacts.pages.customerEdit.states.transport'),
      unavailable: t('contacts.pages.customerEdit.states.unavailable'),
    },
    title: t('contacts.pages.customerEdit.title'),
  };
  ...
  return (
    ...
    >
      ...
      <header className="contacts:grid contacts:gap-2">
        <h1 className="contacts:text-3xl contacts:font-bold" id="customer-edit-heading">
          {copy.title}
        </h1>
