...
export const customerListQueryKey = ({ offset, status }: CustomerListUrlState) =>
  ['contacts', 'customers', 'list', { limit: CUSTOMER_LIST_PAGE_SIZE, offset, status }] as const;
...
const LoadingCustomerTable = ({ copy }: { readonly copy: CustomersListCopy }) => (
  ...
  >
    <Table aria-busy="true" className="contacts:min-w-3xl" size="sm" variant="line">
...
export const CustomersListView = ({
  ...
  const createHref = `/${language}/contacts/customers/context/new`;
  const statusItems = [
  ...
  return (
    ...
    >
      <div className="contacts:grid contacts:gap-4 contacts:sm:grid-cols-[minmax(0,1fr)_minmax(12rem,18rem)] contacts:sm:items-end">
        <div className="contacts:flex contacts:flex-wrap contacts:items-center contacts:justify-between contacts:gap-3">
          <h1 className="contacts:text-3xl contacts:font-bold" id="customers-list-heading">
            {copy.tableCaption}
          </h1>
...
const CustomersListFeature = () => {
  ...
  const copy: CustomersListCopy = {
    actionsColumn: t('contacts.pages.customersList.table.actions'),
    archive: t('contacts.pages.customersList.table.archive'),
    archiving: t('contacts.pages.customersList.table.archiving'),
    authenticationExpired: t('contacts.pages.customersList.states.authenticationExpired'),
    create: t('contacts.pages.customerCreate.title'),
    createdAtColumn: t('contacts.pages.customersList.table.createdAt'),
    decode: t('contacts.pages.customersList.states.decode'),
    edit: t('contacts.pages.customersList.table.edit'),
    empty: t('contacts.pages.customersList.states.empty'),
    filterActive: t('contacts.pages.customersList.filter.active'),
    filterAll: t('contacts.pages.customersList.filter.all'),
    filterArchived: t('contacts.pages.customersList.filter.archived'),
    filterLabel: t('contacts.pages.customersList.filter.label'),
    filterPlaceholder: t('contacts.pages.customersList.filter.placeholder'),
    forbidden: t('contacts.pages.customersList.states.forbidden'),
    internal: t('contacts.pages.customersList.states.internal'),
    lifecycleAuthenticationExpired: t(
      'contacts.pages.customersList.lifecycle.authenticationExpired',
    ),
    lifecycleConflict: t('contacts.pages.customersList.lifecycle.conflict'),
    lifecycleForbidden: t('contacts.pages.customersList.lifecycle.forbidden'),
    lifecycleInvalid: t('contacts.pages.customersList.lifecycle.invalid'),
    lifecycleNotFound: t('contacts.pages.customersList.lifecycle.notFound'),
    lifecycleUnavailable: t('contacts.pages.customersList.lifecycle.unavailable'),
    lifecycleUnexpected: t('contacts.pages.customersList.lifecycle.unexpected'),
    loading: t('contacts.pages.customersList.states.loading'),
    nameColumn: t('contacts.pages.customersList.table.name'),
    next: t('contacts.pages.customersList.pagination.next'),
    paginationLabel: t('contacts.pages.customersList.pagination.label'),
    previous: t('contacts.pages.customersList.pagination.previous'),
    retry: t('contacts.pages.customersList.states.retry'),
    retrying: t('contacts.pages.customersList.states.retrying'),
    statusActive: t('contacts.pages.customersList.status.active'),
    statusArchived: t('contacts.pages.customersList.status.archived'),
    statusColumn: t('contacts.pages.customersList.table.status'),
    tableCaption: t('contacts.pages.customersList.table.caption'),
    transport: t('contacts.pages.customersList.states.transport'),
    unarchive: t('contacts.pages.customersList.table.unarchive'),
    unarchiving: t('contacts.pages.customersList.table.unarchiving'),
    unavailable: t('contacts.pages.customersList.states.unavailable'),
    updatedAtColumn: t('contacts.pages.customersList.table.updatedAt'),
  };
  ...
  if (query.isPending) {
    ...
    view = {
      items: query.data.items.map((customer) => {
        const detailHref = `/${language}/contacts/customers/${encodeURIComponent(customer.customerId)}`;
        return {
