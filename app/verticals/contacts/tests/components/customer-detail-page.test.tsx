...
} from '../../src/routes/[lang]/contacts/customers/[id]/page.tsx';
...
const translations = {
  cs: {
    'contacts.pages.contactCreate.title': 'Vytvořit kontakt',
    'contacts.pages.contactEdit.title': 'Upravit kontakt',
    'contacts.pages.customerDetail.back': 'Zpět',
    'contacts.pages.customerDetail.contacts.filter.active': 'Aktivní',
    'contacts.pages.customerDetail.contacts.filter.all': 'Všichni',
    'contacts.pages.customerDetail.contacts.filter.archived': 'Archivovaní',
    'contacts.pages.customerDetail.contacts.filter.label': 'Stav kontaktu',
    'contacts.pages.customerDetail.contacts.filter.placeholder': 'Vyberte stav',
    'contacts.pages.customerDetail.contacts.heading': 'Kontakty',
    'contacts.pages.customerDetail.contacts.lifecycle.authenticationExpired': 'Relace vypršela.',
    'contacts.pages.customerDetail.contacts.lifecycle.conflict': 'Stav se změnil.',
    'contacts.pages.customerDetail.contacts.lifecycle.forbidden': 'Změna není povolena.',
    'contacts.pages.customerDetail.contacts.lifecycle.invalid': 'Požadavek není platný.',
    'contacts.pages.customerDetail.contacts.lifecycle.notFound': 'Kontakt nebyl nalezen.',
    'contacts.pages.customerDetail.contacts.lifecycle.unavailable': 'Změna není dostupná.',
    'contacts.pages.customerDetail.contacts.lifecycle.unexpected': 'Změna se nezdařila.',
    'contacts.pages.customerDetail.contacts.pagination.label': 'Stránky kontaktů zákazníka',
    'contacts.pages.customerDetail.contacts.pagination.next': 'Další',
    'contacts.pages.customerDetail.contacts.pagination.previous': 'Předchozí',
    'contacts.pages.customerDetail.contacts.states.authenticationExpired':
      'Vaše relace vypršela. Po přihlášení načtěte kontakty znovu.',
    'contacts.pages.customerDetail.contacts.states.decode':
      'Odpověď se seznamem kontaktů se nepodařilo přečíst. Zkuste to znovu.',
    'contacts.pages.customerDetail.contacts.states.empty':
      'Tomuto filtru neodpovídají žádné kontakty.',
    'contacts.pages.customerDetail.contacts.states.forbidden':
      'Nemáte oprávnění zobrazit kontakty tohoto zákazníka.',
    'contacts.pages.customerDetail.contacts.states.internal':
      'Kontakty se nepodařilo bezpečně načíst. Zkuste to znovu.',
    'contacts.pages.customerDetail.contacts.states.loading': 'Načítání kontaktů…',
    'contacts.pages.customerDetail.contacts.states.parentNotFound':
      'Zákazník pro tento seznam kontaktů již neexistuje.',
    'contacts.pages.customerDetail.contacts.states.retry': 'Zkusit znovu',
    'contacts.pages.customerDetail.contacts.states.retrying': 'Opakování…',
    'contacts.pages.customerDetail.contacts.states.transport':
      'Kontakty nejsou dostupné. Zkontrolujte připojení a zkuste to znovu.',
    'contacts.pages.customerDetail.contacts.states.unavailable':
      'Kontakty jsou dočasně nedostupné. Zkuste to znovu.',
    'contacts.pages.customerDetail.contacts.status.active': 'Aktivní',
    'contacts.pages.customerDetail.contacts.status.archived': 'Archivovaný',
    'contacts.pages.customerDetail.contacts.table.actions': 'Akce',
    'contacts.pages.customerDetail.contacts.table.archive': 'Archivovat',
    'contacts.pages.customerDetail.contacts.table.archiving': 'Archivuji…',
    'contacts.pages.customerDetail.contacts.table.caption': 'Kontakty zákazníka',
    'contacts.pages.customerDetail.contacts.table.edit': 'Upravit',
    'contacts.pages.customerDetail.contacts.table.email': 'E-mail',
    'contacts.pages.customerDetail.contacts.table.name': 'Jméno',
    'contacts.pages.customerDetail.contacts.table.phone': 'Telefon',
    'contacts.pages.customerDetail.contacts.table.status': 'Stav',
    'contacts.pages.customerDetail.contacts.table.unarchive': 'Odarchivovat',
    'contacts.pages.customerDetail.contacts.table.unarchiving': 'Ruším archivaci…',
    'contacts.pages.customerDetail.edit': 'Upravit',
    'contacts.pages.customerDetail.fields.createdAt': 'Vytvořeno',
    'contacts.pages.customerDetail.fields.customerId': 'ID zákazníka',
    'contacts.pages.customerDetail.fields.dic': 'DIČ',
    'contacts.pages.customerDetail.fields.dissolvedOn': 'Datum zániku',
    'contacts.pages.customerDetail.fields.establishedOn': 'Datum vzniku',
    'contacts.pages.customerDetail.fields.ico': 'IČO',
    'contacts.pages.customerDetail.fields.legalFormCode': 'Kód právní formy',
    'contacts.pages.customerDetail.fields.status': 'Stav',
    'contacts.pages.customerDetail.fields.unavailable': 'Neuvedeno',
    'contacts.pages.customerDetail.fields.updatedAt': 'Aktualizováno',
    'contacts.pages.customerDetail.lifecycle.active': 'Aktivní',
    'contacts.pages.customerDetail.lifecycle.archived': 'Archivovaný',
    'contacts.pages.customerDetail.states.authenticationExpired':
      'Vaše relace vypršela. Po přihlášení to zkuste znovu.',
    'contacts.pages.customerDetail.states.decode':
      'Odpověď s údaji zákazníka se nepodařilo přečíst. Zkuste to znovu.',
    'contacts.pages.customerDetail.states.forbidden': 'Nemáte oprávnění zobrazit tohoto zákazníka.',
    'contacts.pages.customerDetail.states.internal':
      'Zákazníka se nepodařilo bezpečně načíst. Zkuste to znovu.',
    'contacts.pages.customerDetail.states.loading': 'Načítání údajů zákazníka…',
    'contacts.pages.customerDetail.states.notFound': 'Tohoto zákazníka se nepodařilo najít.',
    'contacts.pages.customerDetail.states.retry': 'Zkusit znovu',
    'contacts.pages.customerDetail.states.retrying': 'Opakování…',
    'contacts.pages.customerDetail.states.transport':
      'Zákazník není dostupný. Zkontrolujte připojení a zkuste to znovu.',
    'contacts.pages.customerDetail.states.unavailable':
      'Zákazník je dočasně nedostupný. Zkuste to znovu.',
    'contacts.pages.customerDetail.title': 'Detail zákazníka',
  },
  en: {
    'contacts.pages.contactCreate.title': 'Create Contact',
    'contacts.pages.contactEdit.title': 'Edit Contact',
    'contacts.pages.customerDetail.back': 'Back',
    'contacts.pages.customerDetail.contacts.filter.active': 'Active',
    'contacts.pages.customerDetail.contacts.filter.all': 'All',
    'contacts.pages.customerDetail.contacts.filter.archived': 'Archived',
    'contacts.pages.customerDetail.contacts.filter.label': 'Contact status',
    'contacts.pages.customerDetail.contacts.filter.placeholder': 'Choose a status',
    'contacts.pages.customerDetail.contacts.heading': 'Contacts',
    'contacts.pages.customerDetail.contacts.lifecycle.authenticationExpired':
      'Your session expired.',
    'contacts.pages.customerDetail.contacts.lifecycle.conflict': 'The status changed.',
    'contacts.pages.customerDetail.contacts.lifecycle.forbidden': 'The change is forbidden.',
    'contacts.pages.customerDetail.contacts.lifecycle.invalid': 'The request is invalid.',
    'contacts.pages.customerDetail.contacts.lifecycle.notFound': 'The Contact was not found.',
    'contacts.pages.customerDetail.contacts.lifecycle.unavailable': 'The change is unavailable.',
    'contacts.pages.customerDetail.contacts.lifecycle.unexpected': 'The change failed.',
    'contacts.pages.customerDetail.contacts.pagination.label': 'Customer Contact pages',
    'contacts.pages.customerDetail.contacts.pagination.next': 'Next',
    'contacts.pages.customerDetail.contacts.pagination.previous': 'Previous',
    'contacts.pages.customerDetail.contacts.states.authenticationExpired':
      'Your session has expired. Sign in and load the Contacts again.',
    'contacts.pages.customerDetail.contacts.states.decode':
      'The Contact list response could not be read. Try again.',
    'contacts.pages.customerDetail.contacts.states.empty': 'No Contacts match this filter.',
    'contacts.pages.customerDetail.contacts.states.forbidden':
      'You do not have permission to view this Customer’s Contacts.',
    'contacts.pages.customerDetail.contacts.states.internal':
      'The Contacts could not be loaded safely. Try again.',
    'contacts.pages.customerDetail.contacts.states.loading': 'Loading Contacts…',
    'contacts.pages.customerDetail.contacts.states.parentNotFound':
      'The Customer for this Contact list no longer exists.',
    'contacts.pages.customerDetail.contacts.states.retry': 'Try again',
    'contacts.pages.customerDetail.contacts.states.retrying': 'Trying again…',
    'contacts.pages.customerDetail.contacts.states.transport':
      'The Contacts could not be reached. Check your connection and try again.',
    'contacts.pages.customerDetail.contacts.states.unavailable':
      'The Contacts are temporarily unavailable. Try again.',
    'contacts.pages.customerDetail.contacts.status.active': 'Active',
    'contacts.pages.customerDetail.contacts.status.archived': 'Archived',
    'contacts.pages.customerDetail.contacts.table.actions': 'Actions',
    'contacts.pages.customerDetail.contacts.table.archive': 'Archive',
    'contacts.pages.customerDetail.contacts.table.archiving': 'Archiving…',
    'contacts.pages.customerDetail.contacts.table.caption': 'Customer Contacts',
    'contacts.pages.customerDetail.contacts.table.edit': 'Edit',
    'contacts.pages.customerDetail.contacts.table.email': 'Email',
    'contacts.pages.customerDetail.contacts.table.name': 'Name',
    'contacts.pages.customerDetail.contacts.table.phone': 'Phone',
    'contacts.pages.customerDetail.contacts.table.status': 'Status',
    'contacts.pages.customerDetail.contacts.table.unarchive': 'Unarchive',
    'contacts.pages.customerDetail.contacts.table.unarchiving': 'Unarchiving…',
    'contacts.pages.customerDetail.edit': 'Edit',
    'contacts.pages.customerDetail.fields.createdAt': 'Created',
    'contacts.pages.customerDetail.fields.customerId': 'Customer ID',
    'contacts.pages.customerDetail.fields.dic': 'Tax ID',
    'contacts.pages.customerDetail.fields.dissolvedOn': 'Dissolution date',
    'contacts.pages.customerDetail.fields.establishedOn': 'Establishment date',
    'contacts.pages.customerDetail.fields.ico': 'Company ID (IČO)',
    'contacts.pages.customerDetail.fields.legalFormCode': 'Legal-form code',
    'contacts.pages.customerDetail.fields.status': 'Status',
    'contacts.pages.customerDetail.fields.unavailable': 'Not available',
    'contacts.pages.customerDetail.fields.updatedAt': 'Updated',
    'contacts.pages.customerDetail.lifecycle.active': 'Active',
    'contacts.pages.customerDetail.lifecycle.archived': 'Archived',
    'contacts.pages.customerDetail.states.authenticationExpired':
      'Your session has expired. Try again after signing in.',
    'contacts.pages.customerDetail.states.decode':
      'The Customer response could not be read. Try again.',
    'contacts.pages.customerDetail.states.forbidden':
      'You do not have permission to view this Customer.',
    'contacts.pages.customerDetail.states.internal':
      'The Customer could not be loaded safely. Try again.',
    'contacts.pages.customerDetail.states.loading': 'Loading Customer details…',
    'contacts.pages.customerDetail.states.notFound': 'This Customer could not be found.',
    'contacts.pages.customerDetail.states.retry': 'Try again',
    'contacts.pages.customerDetail.states.retrying': 'Trying again…',
    'contacts.pages.customerDetail.states.transport':
      'The Customer could not be reached. Check your connection and try again.',
    'contacts.pages.customerDetail.states.unavailable':
      'The Customer is temporarily unavailable. Try again.',
    'contacts.pages.customerDetail.title': 'Customer detail',
  },
} as const;
...
describe('Customer Contact list URL state', () => {
  ...
  test('builds localized Customer detail links while retaining unrelated query state', () => {
    ...
    ).toBe(`/en/contacts/customers/${activeCustomer.customerId}?view=compact&status=active`);
  });
});

test('loads the Customer and its active Contacts through the typed Contacts client with exact BFF options', async () => {
...
test('renders the Customer overview followed by ordered semantic Contact rows', async () => {
  ...
  expect(screen.getAllByRole('link', { name: 'Edit' })[0]?.getAttribute('href')).toBe(
    `/en/contacts/customers/${activeCustomer.customerId}/edit`,
  );
  ...
  expect(list?.className).toContain('contacts:min-w-0');
  for (const term of list?.querySelectorAll('dt') ?? []) {
    expect(term.nextElementSibling?.tagName).toBe('DD');
  }
  for (const value of list?.querySelectorAll('code') ?? []) {
    expect(value.parentElement?.className).toContain('contacts:break-all');
  }
  ...
  expect(within(activeRow).getByRole('link', { name: 'Ada Lovelace' }).getAttribute('href')).toBe(
    `/en/contacts/customers/${activeCustomer.customerId}/contacts/${contacts[0].contactId}`,
  );
  expect(
  ...
  expect(editLink.getAttribute('href')).toBe(
    `/en/contacts/customers/${activeCustomer.customerId}/contacts/${contacts[0].contactId}/edit`,
  );
...
test('renders the empty Contact table without data rows', async () => {
  ...
  expect(emptyDescription.className).toContain('contacts:sr-only');
  ...
  expect(screen.getByRole('link', { name: 'Create Contact' }).getAttribute('href')).toBe(
    `/en/contacts/customers/${activeCustomer.customerId}/contacts/new`,
  );
});
...
test('renders Czech archived data and preserves the active locale in the return link', async () => {
  ...
  expect(screen.getAllByRole('link', { name: 'Upravit' })[0]?.getAttribute('href')).toBe(
    `/cs/contacts/customers/${archivedCustomer.customerId}/edit`,
  );
  ...
  expect(screen.getByRole('link', { name: 'Vytvořit kontakt' }).getAttribute('href')).toBe(
    `/cs/contacts/customers/${archivedCustomer.customerId}/contacts/new`,
  );
...
test('navigates Contact pages while retaining status and unrelated query state', async () => {
  ...
  expect(screen.getByRole('link', { name: 'Next' }).getAttribute('href')).toBe(
    `/en/contacts/customers/${activeCustomer.customerId}?view=compact&status=active&offset=25`,
  );
});
...
test('navigates to the previous Contact page and removes the zero offset', async () => {
  ...
  expect(screen.getByRole('link', { name: 'Previous' }).getAttribute('href')).toBe(
    `/en/contacts/customers/${activeCustomer.customerId}?view=compact&status=archived`,
  );
});
...
test('filters Contacts by status and resets pagination to the first page', async () => {
  ...
  expect(navigateMock).toHaveBeenCalledWith({
    to: `/en/contacts/customers/${activeCustomer.customerId}?view=compact&status=archived`,
  });
});
...
test('keeps locale parity and the page source on the generated frontend seam', () => {
  expect(flattenKeys(csCatalog.contacts.pages.customerDetail)).toEqual(
    flattenKeys(enCatalog.contacts.pages.customerDetail),
  );
  const source = readFileSync(
    new URL('../../src/routes/[lang]/contacts/customers/[id]/page.tsx', import.meta.url),
    'utf-8',
  );
  expect(source).toContain("from '../../../../../api/contacts-client.ts'");
