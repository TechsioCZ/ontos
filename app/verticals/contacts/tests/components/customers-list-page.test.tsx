...
} from '../../src/routes/[lang]/contacts/customers/page.tsx';
...
const translations = {
  cs: {
    'contacts.pages.customerCreate.title': 'Vytvořit zákazníka',
    'contacts.pages.customerEdit.title': 'Upravit zákazníka',
    'contacts.pages.customersList.filter.active': 'Aktivní',
    'contacts.pages.customersList.filter.all': 'Všichni',
    'contacts.pages.customersList.filter.archived': 'Archivovaní',
    'contacts.pages.customersList.filter.label': 'Stav zákazníka',
    'contacts.pages.customersList.filter.placeholder': 'Vyberte stav',
    'contacts.pages.customersList.lifecycle.authenticationExpired': 'Relace vypršela.',
    'contacts.pages.customersList.lifecycle.conflict': 'Stav se změnil.',
    'contacts.pages.customersList.lifecycle.forbidden': 'Změna není povolena.',
    'contacts.pages.customersList.lifecycle.invalid': 'Požadavek není platný.',
    'contacts.pages.customersList.lifecycle.notFound': 'Zákazník nebyl nalezen.',
    'contacts.pages.customersList.lifecycle.unavailable': 'Změna není dostupná.',
    'contacts.pages.customersList.lifecycle.unexpected': 'Změna se nezdařila.',
    'contacts.pages.customersList.pagination.label': 'Stránky seznamu zákazníků',
    'contacts.pages.customersList.pagination.next': 'Další',
    'contacts.pages.customersList.pagination.previous': 'Předchozí',
    'contacts.pages.customersList.states.authenticationExpired':
      'Vaše relace vypršela. Po přihlášení to zkuste znovu.',
    'contacts.pages.customersList.states.decode':
      'Odpověď se seznamem zákazníků se nepodařilo přečíst. Zkuste to znovu.',
    'contacts.pages.customersList.states.empty': 'Tomuto filtru neodpovídají žádní zákazníci.',
    'contacts.pages.customersList.states.forbidden': 'Nemáte oprávnění zobrazit zákazníky.',
    'contacts.pages.customersList.states.internal':
      'Seznam zákazníků se nepodařilo bezpečně načíst. Zkuste to znovu.',
    'contacts.pages.customersList.states.loading': 'Načítání zákazníků…',
    'contacts.pages.customersList.states.retry': 'Zkusit znovu',
    'contacts.pages.customersList.states.retrying': 'Opakování…',
    'contacts.pages.customersList.states.transport':
      'Seznam zákazníků není dostupný. Zkontrolujte připojení a zkuste to znovu.',
    'contacts.pages.customersList.states.unavailable':
      'Seznam zákazníků je dočasně nedostupný. Zkuste to znovu.',
    'contacts.pages.customersList.status.active': 'Aktivní',
    'contacts.pages.customersList.status.archived': 'Archivovaný',
    'contacts.pages.customersList.table.actions': 'Akce',
    'contacts.pages.customersList.table.archive': 'Archivovat',
    'contacts.pages.customersList.table.archiving': 'Archivace…',
    'contacts.pages.customersList.table.caption': 'Zákazníci',
    'contacts.pages.customersList.table.createdAt': 'Vytvořeno',
    'contacts.pages.customersList.table.edit': 'Upravit',
    'contacts.pages.customersList.table.name': 'Jméno zákazníka',
    'contacts.pages.customersList.table.status': 'Stav',
    'contacts.pages.customersList.table.unarchive': 'Odarchivovat',
    'contacts.pages.customersList.table.unarchiving': 'Ruším archivaci…',
    'contacts.pages.customersList.table.updatedAt': 'Aktualizováno',
  },
  en: {
    'contacts.pages.customerCreate.title': 'Create Customer',
    'contacts.pages.customerEdit.title': 'Edit Customer',
    'contacts.pages.customersList.filter.active': 'Active',
    'contacts.pages.customersList.filter.all': 'All',
    'contacts.pages.customersList.filter.archived': 'Archived',
    'contacts.pages.customersList.filter.label': 'Customer status',
    'contacts.pages.customersList.filter.placeholder': 'Choose a status',
    'contacts.pages.customersList.lifecycle.authenticationExpired': 'Your session expired.',
    'contacts.pages.customersList.lifecycle.conflict': 'The status changed.',
    'contacts.pages.customersList.lifecycle.forbidden': 'The change is forbidden.',
    'contacts.pages.customersList.lifecycle.invalid': 'The request is invalid.',
    'contacts.pages.customersList.lifecycle.notFound': 'The Customer was not found.',
    'contacts.pages.customersList.lifecycle.unavailable': 'The change is unavailable.',
    'contacts.pages.customersList.lifecycle.unexpected': 'The change failed.',
    'contacts.pages.customersList.pagination.label': 'Customer list pages',
    'contacts.pages.customersList.pagination.next': 'Next',
    'contacts.pages.customersList.pagination.previous': 'Previous',
    'contacts.pages.customersList.states.authenticationExpired':
      'Your session has expired. Try again after signing in.',
    'contacts.pages.customersList.states.decode':
      'The Customer list response could not be read. Try again.',
    'contacts.pages.customersList.states.empty': 'No Customers match this filter.',
    'contacts.pages.customersList.states.forbidden':
      'You do not have permission to view Customers.',
    'contacts.pages.customersList.states.internal':
      'The Customer list could not be loaded safely. Try again.',
    'contacts.pages.customersList.states.loading': 'Loading Customers…',
    'contacts.pages.customersList.states.retry': 'Try again',
    'contacts.pages.customersList.states.retrying': 'Trying again…',
    'contacts.pages.customersList.states.transport':
    ...
    'contacts.pages.customersList.status.active': 'Active',
    'contacts.pages.customersList.status.archived': 'Archived',
    'contacts.pages.customersList.table.actions': 'Actions',
    'contacts.pages.customersList.table.archive': 'Archive',
    'contacts.pages.customersList.table.archiving': 'Archiving…',
    'contacts.pages.customersList.table.caption': 'Customers',
    'contacts.pages.customersList.table.createdAt': 'Created',
    'contacts.pages.customersList.table.edit': 'Edit',
    'contacts.pages.customersList.table.name': 'Customer name',
    'contacts.pages.customersList.table.status': 'Status',
    'contacts.pages.customersList.table.unarchive': 'Unarchive',
    'contacts.pages.customersList.table.unarchiving': 'Unarchiving…',
    'contacts.pages.customersList.table.updatedAt': 'Updated',
  },
} as const;
...
describe('Customer list URL state', () => {
  ...
  test('builds a stable query key and localized links while retaining unrelated query state', () => {
    ...
    expect(buildCustomerListHref('en', '?view=compact&status=all&offset=50', 'active', 0)).toBe(
      '/en/contacts/customers?view=compact&status=active',
    );
  });
});

test('loads the initial page once through the typed Contacts client with the exact bounded payload', async () => {
...
test('renders semantic Customer values, ordered rows, localized dates, badges, and honest links', async () => {
  ...
  ).toBe(`/en/contacts/customers/${activeCustomer.customerId}`);
  ...
  expect(screen.getByRole('link', { name: 'Previous' }).getAttribute('href')).toBe(
    '/en/contacts/customers?view=compact&status=all',
  );
  expect(screen.getByRole('link', { name: 'Next' }).getAttribute('href')).toBe(
    '/en/contacts/customers?view=compact&status=all&offset=50',
  );
});
...
test('shows the empty Customer table without data rows or a pager', async () => {
  ...
  expect(screen.getByRole('link', { name: 'Create Customer' }).getAttribute('href')).toBe(
    '/en/contacts/customers/context/new',
  );
...
test('changes the status filter by keyboard, retains safe query state, and resets the offset', async () => {
  ...
  expect(navigateMock).toHaveBeenCalledWith({
    to: '/en/contacts/customers?view=compact&status=archived',
  });
});
...
test('renders Czech-owned heading, filter, status, dates, errors, retry, and navigation copy', async () => {
  ...
  expect(screen.getByRole('link', { name: 'Vytvořit zákazníka' }).getAttribute('href')).toBe(
    '/cs/contacts/customers/context/new',
  );
...
test('owns the UI-kit token, theme, class source, and local overflow boundary', async () => {
  ...
  expect(appCss).toContain("@import 'tailwindcss' prefix(contacts) source(none);");
  expect(federationConfig).toContain("!asset.includes('/async-index.')");
  expect(federationPage).toContain("import '../routes/index.css';");

  render(<CustomersListPage />);
  await screen.findByRole('table', { name: 'Customers' });
  expect(screen.getByTestId('customers-table-overflow').className).toContain(
...
test('keeps English and Czech Customer-list locale structures in parity', () => {
  expect(flattenKeys(csCatalog.contacts.pages.customersList)).toEqual(
    flattenKeys(enCatalog.contacts.pages.customersList),
  );
});
