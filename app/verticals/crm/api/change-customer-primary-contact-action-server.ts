...
import { ChangeCustomerPrimaryContactSchemaErrorMiddleware } from '../shared/apis/change-customer-primary-contact-action.ts';
import { crmApi } from '../shared/api.ts';
import {
  ChangeCustomerPrimaryContactPolicyDenialStatuses,
  changeCustomerPrimaryContactAction,
} from '../src/actions/change-customer-primary-contact.action.ts';
import type { ChangeCustomerPrimaryContactDomainError } from '../src/actions/change-customer-primary-contact.action.ts';
...
const validationProblem = () =>
  problem(
    'ChangeCustomerPrimaryContactValidationProblem' as const,
    400 as const,
...
const authenticationProblem = () =>
  problem(
    'ChangeCustomerPrimaryContactAuthenticationProblem' as const,
    401 as const,
...
const forbiddenProblem = () =>
  problem(
    'ChangeCustomerPrimaryContactForbiddenProblem' as const,
    403 as const,
    'Action forbidden',
...
const notFoundProblem = () =>
  problem(
    'ChangeCustomerPrimaryContactNotFoundProblem' as const,
    404 as const,
...
const conflictProblem = () =>
  problem(
    'ChangeCustomerPrimaryContactConflictProblem' as const,
    409 as const,
    'Action conflict',
...
const rejectedProblem = () =>
  problem(
    'ChangeCustomerPrimaryContactRejectedProblem' as const,
    422 as const,
    'Action rejected',
...
const preconditionProblem = () =>
  problem(
    'ChangeCustomerPrimaryContactPreconditionProblem' as const,
    428 as const,
...
const internalProblem = () =>
  problem(
    'ChangeCustomerPrimaryContactInternalProblem' as const,
    500 as const,
    'Action failed',
...
const unavailableProblem = () => ({
  ...problem(
    'ChangeCustomerPrimaryContactUnavailableProblem' as const,
    503 as const,
    'Action unavailable',
...
type ActionFailure = ActionCoreError | ChangeCustomerPrimaryContactDomainError;
...
const actionProblemByTag = {
  ...
  ChangeCustomerPrimaryContactConflict: () => conflictProblem(),
  ChangeCustomerPrimaryContactNotFound: () => notFoundProblem(),
  ChangeCustomerPrimaryContactRejected: () => rejectedProblem(),
  ChangeCustomerPrimaryContactUnavailable: () => unavailableProblem(),
...
const changeCustomerPrimaryContactActionSchemaErrorLive =
  HttpApiMiddleware.layerSchemaErrorTransform(
    ChangeCustomerPrimaryContactSchemaErrorMiddleware,
    () => Effect.fail(validationProblem()),
  );

export const changeCustomerPrimaryContactActionApiLive = HttpApiBuilder.group(
  crmApi,
  'changeCustomerPrimaryContactActions',
  (handlers) =>
    handlers.handle('execute', ({ headers, payload }) =>
      Effect.gen(function* executeChangeCustomerPrimaryContactAction() {
          ...
          .pipe(
            Effect.catchCause((cause) => {
              ...
              return Effect.logError(
                'Unexpected ChangeCustomerPrimaryContact Action transport defect',
                cause,
              ).pipe(Effect.andThen(Effect.fail<EndpointProblem>(internalProblem())));
            }),
          );
      }),
    ),
).pipe(Layer.provide(changeCustomerPrimaryContactActionSchemaErrorLive));
