...
import { CreateCustomerSchemaErrorMiddleware } from '../shared/apis/create-customer-action.ts';
import { crmApi } from '../shared/api.ts';
import {
  CreateCustomerPolicyDenialStatuses,
  createCustomerAction,
} from '../src/actions/create-customer.action.ts';
import type { CreateCustomerDomainError } from '../src/actions/create-customer.action.ts';
...
const validationProblem = () =>
  problem(
    'CreateCustomerValidationProblem' as const,
    400 as const,
...
const authenticationProblem = () =>
  problem(
    'CreateCustomerAuthenticationProblem' as const,
    401 as const,
...
const forbiddenProblem = () =>
  problem(
    'CreateCustomerForbiddenProblem' as const,
    403 as const,
    'Action forbidden',
...
const notFoundProblem = () =>
  problem(
    'CreateCustomerNotFoundProblem' as const,
    404 as const,
...
const conflictProblem = () =>
  problem(
    'CreateCustomerConflictProblem' as const,
    409 as const,
    'Action conflict',
...
const rejectedProblem = () =>
  problem(
    'CreateCustomerRejectedProblem' as const,
    422 as const,
    'Action rejected',
...
const preconditionProblem = () =>
  problem(
    'CreateCustomerPreconditionProblem' as const,
    428 as const,
...
const internalProblem = () =>
  problem(
    'CreateCustomerInternalProblem' as const,
    500 as const,
    'Action failed',
...
const unavailableProblem = () => ({
  ...problem(
    'CreateCustomerUnavailableProblem' as const,
    503 as const,
    'Action unavailable',
...
type ActionFailure = ActionCoreError | CreateCustomerDomainError;
...
const actionProblemByTag = {
  ...
  CreateCustomerConflict: () => conflictProblem(),
  CreateCustomerNotFound: () => notFoundProblem(),
  CreateCustomerRejected: () => rejectedProblem(),
  CreateCustomerUnavailable: () => unavailableProblem(),
...
const createCustomerActionSchemaErrorLive = HttpApiMiddleware.layerSchemaErrorTransform(
  CreateCustomerSchemaErrorMiddleware,
  () => Effect.fail(validationProblem()),
);

export const createCustomerActionApiLive = HttpApiBuilder.group(
  crmApi,
  'createCustomerActions',
  (handlers) =>
    handlers.handle('execute', ({ headers, payload }) =>
      Effect.gen(function* executeCreateCustomerAction() {
          ...
          .pipe(
            Effect.catchCause((cause) => {
              ...
              return Effect.logError(
                'Unexpected CreateCustomer Action transport defect',
                cause,
...
).pipe(Layer.provide(createCustomerActionSchemaErrorLive));
