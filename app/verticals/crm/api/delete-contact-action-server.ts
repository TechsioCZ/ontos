...
import { DeleteContactSchemaErrorMiddleware } from '../shared/apis/delete-contact-action.ts';
import { crmApi } from '../shared/api.ts';
import {
  DeleteContactPolicyDenialStatuses,
  deleteContactAction,
} from '../src/actions/delete-contact.action.ts';
import type { DeleteContactDomainError } from '../src/actions/delete-contact.action.ts';
...
const validationProblem = () =>
  problem(
    'DeleteContactValidationProblem' as const,
    400 as const,
...
const authenticationProblem = () =>
  problem(
    'DeleteContactAuthenticationProblem' as const,
    401 as const,
...
const forbiddenProblem = () =>
  problem(
    'DeleteContactForbiddenProblem' as const,
    403 as const,
    'Action forbidden',
...
const notFoundProblem = () =>
  problem(
    'DeleteContactNotFoundProblem' as const,
    404 as const,
...
const conflictProblem = () =>
  problem(
    'DeleteContactConflictProblem' as const,
    409 as const,
    'Action conflict',
...
const rejectedProblem = () =>
  problem(
    'DeleteContactRejectedProblem' as const,
    422 as const,
    'Action rejected',
...
const preconditionProblem = () =>
  problem(
    'DeleteContactPreconditionProblem' as const,
    428 as const,
...
const internalProblem = () =>
  problem(
    'DeleteContactInternalProblem' as const,
    500 as const,
    'Action failed',
...
const unavailableProblem = () => ({
  ...problem(
    'DeleteContactUnavailableProblem' as const,
    503 as const,
    'Action unavailable',
...
type ActionFailure = ActionCoreError | DeleteContactDomainError;
...
const actionProblemByTag = {
  ...
  DeleteContactConflict: () => conflictProblem(),
  DeleteContactNotFound: () => notFoundProblem(),
  DeleteContactRejected: () => rejectedProblem(),
  DeleteContactUnavailable: () => unavailableProblem(),
...
const deleteContactActionSchemaErrorLive = HttpApiMiddleware.layerSchemaErrorTransform(
  DeleteContactSchemaErrorMiddleware,
  () => Effect.fail(validationProblem()),
);

export const deleteContactActionApiLive = HttpApiBuilder.group(
  crmApi,
  'deleteContactActions',
  (handlers) =>
    handlers.handle('execute', ({ headers, payload }) =>
      Effect.gen(function* executeDeleteContactAction() {
        ...
        return yield* runtime
          .runAction({
            payload,
            principal,
            registration: deleteContactAction,
            transport: {
          ...
          .pipe(
            Effect.catchCause((cause) => {
              ...
              return Effect.logError(
                'Unexpected DeleteContact Action transport defect',
                cause,
...
).pipe(Layer.provide(deleteContactActionSchemaErrorLive));
