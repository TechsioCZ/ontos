...
import { DeleteCustomerSchemaErrorMiddleware } from '../shared/apis/delete-customer-action.ts';
import { crmApi } from '../shared/api.ts';
import {
  DeleteCustomerPolicyDenialStatuses,
  deleteCustomerAction,
} from '../src/actions/delete-customer.action.ts';
import type { DeleteCustomerDomainError } from '../src/actions/delete-customer.action.ts';
...
const validationProblem = () =>
  problem(
    'DeleteCustomerValidationProblem' as const,
    400 as const,
...
const authenticationProblem = () =>
  problem(
    'DeleteCustomerAuthenticationProblem' as const,
    401 as const,
...
const forbiddenProblem = () =>
  problem(
    'DeleteCustomerForbiddenProblem' as const,
    403 as const,
    'Action forbidden',
...
const notFoundProblem = () =>
  problem(
    'DeleteCustomerNotFoundProblem' as const,
    404 as const,
...
const conflictProblem = () =>
  problem(
    'DeleteCustomerConflictProblem' as const,
    409 as const,
    'Action conflict',
...
const rejectedProblem = () =>
  problem(
    'DeleteCustomerRejectedProblem' as const,
    422 as const,
    'Action rejected',
...
const preconditionProblem = () =>
  problem(
    'DeleteCustomerPreconditionProblem' as const,
    428 as const,
...
const internalProblem = () =>
  problem(
    'DeleteCustomerInternalProblem' as const,
    500 as const,
    'Action failed',
...
const unavailableProblem = () => ({
  ...problem(
    'DeleteCustomerUnavailableProblem' as const,
    503 as const,
    'Action unavailable',
...
type ActionFailure = ActionCoreError | DeleteCustomerDomainError;
...
const actionProblemByTag = {
  ...
  DeleteCustomerConflict: () => conflictProblem(),
  DeleteCustomerNotFound: () => notFoundProblem(),
  DeleteCustomerRejected: () => rejectedProblem(),
  DeleteCustomerUnavailable: () => unavailableProblem(),
...
const deleteCustomerActionSchemaErrorLive = HttpApiMiddleware.layerSchemaErrorTransform(
  DeleteCustomerSchemaErrorMiddleware,
  () => Effect.fail(validationProblem()),
);

export const deleteCustomerActionApiLive = HttpApiBuilder.group(
  crmApi,
  'deleteCustomerActions',
  (handlers) =>
    handlers.handle('execute', ({ headers, payload }) =>
      Effect.gen(function* executeDeleteCustomerAction() {
        ...
        return yield* runtime
          .runAction({
            payload,
            principal,
            registration: deleteCustomerAction,
            transport: {
          ...
          .pipe(
            Effect.catchCause((cause) => {
              ...
              return Effect.logError(
                'Unexpected DeleteCustomer Action transport defect',
                cause,
...
).pipe(Layer.provide(deleteCustomerActionSchemaErrorLive));
