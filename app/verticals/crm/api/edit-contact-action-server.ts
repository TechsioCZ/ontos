...
import { EditContactSchemaErrorMiddleware } from '../shared/apis/edit-contact-action.ts';
import { crmApi } from '../shared/api.ts';
import {
  EditContactPolicyDenialStatuses,
  editContactAction,
} from '../src/actions/edit-contact.action.ts';
import type { EditContactDomainError } from '../src/actions/edit-contact.action.ts';
...
const validationProblem = () =>
  problem(
    'EditContactValidationProblem' as const,
    400 as const,
...
const authenticationProblem = () =>
  problem(
    'EditContactAuthenticationProblem' as const,
    401 as const,
...
const forbiddenProblem = () =>
  problem(
    'EditContactForbiddenProblem' as const,
    403 as const,
    'Action forbidden',
...
const notFoundProblem = () =>
  problem(
    'EditContactNotFoundProblem' as const,
    404 as const,
...
const conflictProblem = () =>
  problem(
    'EditContactConflictProblem' as const,
    409 as const,
    'Action conflict',
...
const rejectedProblem = () =>
  problem(
    'EditContactRejectedProblem' as const,
    422 as const,
    'Action rejected',
...
const preconditionProblem = () =>
  problem(
    'EditContactPreconditionProblem' as const,
    428 as const,
...
const internalProblem = () =>
  problem(
    'EditContactInternalProblem' as const,
    500 as const,
    'Action failed',
...
const unavailableProblem = () => ({
  ...problem(
    'EditContactUnavailableProblem' as const,
    503 as const,
    'Action unavailable',
...
type ActionFailure = ActionCoreError | EditContactDomainError;
...
const actionProblemByTag = {
  ...
  EditContactConflict: () => conflictProblem(),
  EditContactNotFound: () => notFoundProblem(),
  EditContactRejected: () => rejectedProblem(),
  EditContactUnavailable: () => unavailableProblem(),
...
const editContactActionSchemaErrorLive = HttpApiMiddleware.layerSchemaErrorTransform(
  EditContactSchemaErrorMiddleware,
  () => Effect.fail(validationProblem()),
);

export const editContactActionApiLive = HttpApiBuilder.group(
  crmApi,
  'editContactActions',
  (handlers) =>
    handlers.handle('execute', ({ headers, payload }) =>
      Effect.gen(function* executeEditContactAction() {
        ...
        return yield* runtime
          ...
          .pipe(
            Effect.catchCause((cause) => {
              ...
              return Effect.logError('Unexpected EditContact Action transport defect', cause).pipe(
...
).pipe(Layer.provide(editContactActionSchemaErrorLive));
