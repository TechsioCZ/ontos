...
import { EditCustomerSchemaErrorMiddleware } from '../shared/apis/edit-customer-action.ts';
import { crmApi } from '../shared/api.ts';
import {
  EditCustomerPolicyDenialStatuses,
  editCustomerAction,
} from '../src/actions/edit-customer.action.ts';
import type { EditCustomerDomainError } from '../src/actions/edit-customer.action.ts';
...
const validationProblem = () =>
  problem(
    'EditCustomerValidationProblem' as const,
    400 as const,
...
const authenticationProblem = () =>
  problem(
    'EditCustomerAuthenticationProblem' as const,
    401 as const,
...
const forbiddenProblem = () =>
  problem(
    'EditCustomerForbiddenProblem' as const,
    403 as const,
    'Action forbidden',
...
const notFoundProblem = () =>
  problem(
    'EditCustomerNotFoundProblem' as const,
    404 as const,
...
const conflictProblem = () =>
  problem(
    'EditCustomerConflictProblem' as const,
    409 as const,
    'Action conflict',
...
const rejectedProblem = () =>
  problem(
    'EditCustomerRejectedProblem' as const,
    422 as const,
    'Action rejected',
...
const preconditionProblem = () =>
  problem(
    'EditCustomerPreconditionProblem' as const,
    428 as const,
...
const internalProblem = () =>
  problem(
    'EditCustomerInternalProblem' as const,
    500 as const,
    'Action failed',
...
const unavailableProblem = () => ({
  ...problem(
    'EditCustomerUnavailableProblem' as const,
    503 as const,
    'Action unavailable',
...
type ActionFailure = ActionCoreError | EditCustomerDomainError;
...
const actionProblemByTag = {
  ...
  EditCustomerConflict: () => conflictProblem(),
  EditCustomerNotFound: () => notFoundProblem(),
  EditCustomerRejected: () => rejectedProblem(),
  EditCustomerUnavailable: () => unavailableProblem(),
...
const editCustomerActionSchemaErrorLive = HttpApiMiddleware.layerSchemaErrorTransform(
  EditCustomerSchemaErrorMiddleware,
  () => Effect.fail(validationProblem()),
);

export const editCustomerActionApiLive = HttpApiBuilder.group(
  crmApi,
  'editCustomerActions',
  (handlers) =>
    handlers.handle('execute', ({ headers, payload }) =>
      Effect.gen(function* executeEditCustomerAction() {
        ...
        return yield* runtime
          ...
          .pipe(
            Effect.catchCause((cause) => {
              ...
              return Effect.logError('Unexpected EditCustomer Action transport defect', cause).pipe(
...
).pipe(Layer.provide(editCustomerActionSchemaErrorLive));
