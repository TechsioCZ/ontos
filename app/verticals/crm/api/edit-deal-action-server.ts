...
import { EditDealSchemaErrorMiddleware } from '../shared/apis/edit-deal-action.ts';
import { crmApi } from '../shared/api.ts';
import { EditDealPolicyDenialStatuses, editDealAction } from '../src/actions/edit-deal.action.ts';
import type { EditDealDomainError } from '../src/actions/edit-deal.action.ts';
...
const validationProblem = () =>
  problem(
    'EditDealValidationProblem' as const,
    400 as const,
...
const authenticationProblem = () =>
  problem(
    'EditDealAuthenticationProblem' as const,
    401 as const,
...
const forbiddenProblem = () =>
  problem(
    'EditDealForbiddenProblem' as const,
    403 as const,
    'Action forbidden',
...
const notFoundProblem = () =>
  problem(
    'EditDealNotFoundProblem' as const,
    404 as const,
...
const conflictProblem = () =>
  problem(
    'EditDealConflictProblem' as const,
    409 as const,
    'Action conflict',
...
const rejectedProblem = () =>
  problem(
    'EditDealRejectedProblem' as const,
    422 as const,
    'Action rejected',
...
const preconditionProblem = () =>
  problem(
    'EditDealPreconditionProblem' as const,
    428 as const,
...
const internalProblem = () =>
  problem(
    'EditDealInternalProblem' as const,
    500 as const,
    'Action failed',
...
const unavailableProblem = () => ({
  ...problem(
    'EditDealUnavailableProblem' as const,
    503 as const,
    'Action unavailable',
...
type ActionFailure = ActionCoreError | EditDealDomainError;
...
const actionProblemByTag = {
  ...
  EditDealConflict: () => conflictProblem(),
  EditDealNotFound: () => notFoundProblem(),
  EditDealRejected: () => rejectedProblem(),
  EditDealUnavailable: () => unavailableProblem(),
...
const editDealActionSchemaErrorLive = HttpApiMiddleware.layerSchemaErrorTransform(
  EditDealSchemaErrorMiddleware,
  () => Effect.fail(validationProblem()),
);

export const editDealActionApiLive = HttpApiBuilder.group(crmApi, 'editDealActions', (handlers) =>
  handlers.handle('execute', ({ headers, payload }) =>
    Effect.gen(function* executeEditDealAction() {
      ...
      return yield* runtime
        ...
        .pipe(
          Effect.catchCause((cause) => {
            ...
            return Effect.logError('Unexpected EditDeal Action transport defect', cause).pipe(
...
).pipe(Layer.provide(editDealActionSchemaErrorLive));
