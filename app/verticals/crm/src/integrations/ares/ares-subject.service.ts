...
export const AresIcoSchema = CrmIcoSchema;

const AresRawSubjectSchema = Schema.Struct({
  datumVzniku: Schema.optional(Schema.NullOr(CrmDateOnlySchema)),
  datumZaniku: Schema.optional(Schema.NullOr(CrmDateOnlySchema)),
  dic: Schema.optional(Schema.NullOr(CrmDicSchema)),
  ico: AresIcoSchema,
  obchodniJmeno: CrmPersistedTextSchema,
  pravniForma: Schema.optional(Schema.NullOr(CrmLegalFormCodeSchema)),
});
