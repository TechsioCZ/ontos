...
const authenticationProblem = () => ({
  _tag: 'CounterpartiesProviderAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'CounterpartiesProviderUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'CounterpartiesProviderInvalidProblem' as const,
...
const forbiddenProblem = () => ({
  _tag: 'CounterpartiesProviderForbiddenProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'CounterpartiesProviderNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'CounterpartiesProviderPolicyConflictProblem' as const,
    ...
    : {
        _tag: 'CounterpartiesProviderPolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'CounterpartiesProviderInternalProblem' as const,
