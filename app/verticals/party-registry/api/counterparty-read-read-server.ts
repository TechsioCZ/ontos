...
const authenticationProblem = () => ({
  _tag: 'CounterpartyReadAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'CounterpartyReadUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'CounterpartyReadInvalidProblem' as const,
...
const forbiddenProblem = () => ({
  _tag: 'CounterpartyReadForbiddenProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'CounterpartyReadNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'CounterpartyReadPolicyConflictProblem' as const,
    ...
    : {
        _tag: 'CounterpartyReadPolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'CounterpartyReadInternalProblem' as const,
