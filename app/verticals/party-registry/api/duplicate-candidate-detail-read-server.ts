...
const authenticationProblem = () => ({
  _tag: 'DuplicateCandidateDetailAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'DuplicateCandidateDetailUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'DuplicateCandidateDetailInvalidProblem' as const,
...
const forbiddenProblem = () => ({
  _tag: 'DuplicateCandidateDetailForbiddenProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'DuplicateCandidateDetailNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'DuplicateCandidateDetailPolicyConflictProblem' as const,
    ...
    : {
        _tag: 'DuplicateCandidateDetailPolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'DuplicateCandidateDetailInternalProblem' as const,
