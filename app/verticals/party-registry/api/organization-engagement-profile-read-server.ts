...
const authenticationProblem = () => ({
  _tag: 'OrganizationEngagementProfileAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'OrganizationEngagementProfileUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'OrganizationEngagementProfileInvalidProblem' as const,
...
const forbiddenProblem = () => ({
  _tag: 'OrganizationEngagementProfileForbiddenProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'OrganizationEngagementProfileNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'OrganizationEngagementProfilePolicyConflictProblem' as const,
    ...
    : {
        _tag: 'OrganizationEngagementProfilePolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'OrganizationEngagementProfileInternalProblem' as const,
