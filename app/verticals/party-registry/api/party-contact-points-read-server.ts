...
const authenticationProblem = () => ({
  _tag: 'PartyContactPointsAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'PartyContactPointsUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'PartyContactPointsInvalidProblem' as const,
...
const forbiddenProblem = () => ({
  _tag: 'PartyContactPointsForbiddenProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'PartyContactPointsNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'PartyContactPointsPolicyConflictProblem' as const,
    ...
    : {
        _tag: 'PartyContactPointsPolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'PartyContactPointsInternalProblem' as const,
