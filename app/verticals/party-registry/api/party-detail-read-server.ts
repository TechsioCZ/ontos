...
const authenticationProblem = () => ({
  _tag: 'PartyDetailAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'PartyDetailUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'PartyDetailInvalidProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'PartyDetailNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'PartyDetailPolicyConflictProblem' as const,
    ...
    : {
        _tag: 'PartyDetailPolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'PartyDetailInternalProblem' as const,
