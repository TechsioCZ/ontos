...
const authenticationProblem = () => ({
  _tag: 'PartyMatchAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'PartyMatchUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'PartyMatchInvalidProblem' as const,
...
const forbiddenProblem = () => ({
  _tag: 'PartyMatchForbiddenProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'PartyMatchNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'PartyMatchPolicyConflictProblem' as const,
    ...
    : {
        _tag: 'PartyMatchPolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'PartyMatchInternalProblem' as const,
