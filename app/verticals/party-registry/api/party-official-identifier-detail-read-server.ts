...
const authenticationProblem = () => ({
  _tag: 'PartyOfficialIdentifierDetailAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'PartyOfficialIdentifierDetailUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'PartyOfficialIdentifierDetailInvalidProblem' as const,
...
const forbiddenProblem = () => ({
  _tag: 'PartyOfficialIdentifierDetailForbiddenProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'PartyOfficialIdentifierDetailNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'PartyOfficialIdentifierDetailPolicyConflictProblem' as const,
    ...
    : {
        _tag: 'PartyOfficialIdentifierDetailPolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'PartyOfficialIdentifierDetailInternalProblem' as const,
