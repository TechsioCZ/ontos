...
const authenticationProblem = () => ({
  _tag: 'PartyOfficialIdentifierHistoryAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'PartyOfficialIdentifierHistoryUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'PartyOfficialIdentifierHistoryInvalidProblem' as const,
...
const forbiddenProblem = () => ({
  _tag: 'PartyOfficialIdentifierHistoryForbiddenProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'PartyOfficialIdentifierHistoryNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'PartyOfficialIdentifierHistoryPolicyConflictProblem' as const,
    ...
    : {
        _tag: 'PartyOfficialIdentifierHistoryPolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'PartyOfficialIdentifierHistoryInternalProblem' as const,
