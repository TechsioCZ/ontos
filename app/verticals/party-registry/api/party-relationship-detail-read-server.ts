...
const authenticationProblem = () => ({
  _tag: 'PartyRelationshipDetailAuthenticationProblem' as const,
...
const unavailableProblem = () => ({
  _tag: 'PartyRelationshipDetailUnavailableProblem' as const,
...
const invalidProblem = () => ({
  _tag: 'PartyRelationshipDetailInvalidProblem' as const,
...
const forbiddenProblem = () => ({
  _tag: 'PartyRelationshipDetailForbiddenProblem' as const,
...
const notFoundProblem = () => ({
  _tag: 'PartyRelationshipDetailNotFoundProblem' as const,
...
const policyProblem = (status: 409 | 422) =>
  status === 409
    ? {
        _tag: 'PartyRelationshipDetailPolicyConflictProblem' as const,
    ...
    : {
        _tag: 'PartyRelationshipDetailPolicyProblem' as const,
...
const internalProblem = () => ({
  _tag: 'PartyRelationshipDetailInternalProblem' as const,
