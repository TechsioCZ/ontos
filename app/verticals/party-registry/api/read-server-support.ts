...
export const resolvePartyRegistryShellOrigin = (
  value: string | undefined
): string =>
  value !== undefined && value.trim().length > 0
    ? value
    : DEFAULT_PARTY_REGISTRY_SHELL_ORIGIN;
...
export const partyRegistryCorsAllowedMethods = [
  'GET',
  'HEAD',
  'OPTIONS',
  'POST',
...
export const partyRegistryCorsAllowedOrigins = (
