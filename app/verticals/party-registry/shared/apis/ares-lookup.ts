...
export const AresLookupInvalidProblemSchema = makeProblemDetailsSchema('AresLookupInvalidProblem', 400);
export const AresLookupAuthenticationProblemSchema = makeProblemDetailsSchema('AresLookupAuthenticationProblem', 401);
export const AresLookupForbiddenProblemSchema = makeProblemDetailsSchema('AresLookupForbiddenProblem', 403);
export const AresLookupNotFoundProblemSchema = makeProblemDetailsSchema('AresLookupNotFoundProblem', 404);
export const AresLookupPolicyConflictProblemSchema = makeProblemDetailsSchema('AresLookupPolicyConflictProblem', 409);
export const AresLookupPolicyProblemSchema = makeProblemDetailsSchema('AresLookupPolicyProblem', 422);
export const AresLookupUnavailableProblemSchema = makeRetryableProblemDetailsSchema(
  'AresLookupUnavailableProblem',
  503,
);
export const AresLookupInternalProblemSchema = makeProblemDetailsSchema('AresLookupInternalProblem', 500);
