...
export const PartiesProviderInvalidProblemSchema = makeProblemDetailsSchema('PartiesProviderInvalidProblem', 400);
export const PartiesProviderForbiddenProblemSchema = makeProblemDetailsSchema('PartiesProviderForbiddenProblem', 403);
export const PartiesProviderNotFoundProblemSchema = makeProblemDetailsSchema('PartiesProviderNotFoundProblem', 404);
export const PartiesProviderPolicyProblemSchema = makeProblemDetailsSchema('PartiesProviderPolicyProblem', 422);
export const PartiesProviderPolicyConflictProblemSchema = makeProblemDetailsSchema(
  'PartiesProviderPolicyConflictProblem',
  409,
);
export const PartiesProviderInternalProblemSchema = makeProblemDetailsSchema('PartiesProviderInternalProblem', 500);
