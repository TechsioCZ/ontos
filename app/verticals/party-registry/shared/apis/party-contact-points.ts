...
export const PartyContactPointsInvalidProblemSchema = makeProblemDetailsSchema('PartyContactPointsInvalidProblem', 400);
...
export const PartyContactPointsPolicyProblemSchema = makeProblemDetailsSchema('PartyContactPointsPolicyProblem', 422);
