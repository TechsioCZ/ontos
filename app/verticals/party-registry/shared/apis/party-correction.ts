...
export const PartyCorrectionInvalidProblemSchema = makeProblemDetailsSchema('PartyCorrectionInvalidProblem', 400);
export const PartyCorrectionUnavailableProblemSchema = makeRetryableProblemDetailsSchema(
  'PartyCorrectionUnavailableProblem',
  503,
);
export const PartyCorrectionForbiddenProblemSchema = makeProblemDetailsSchema('PartyCorrectionForbiddenProblem', 403);
export const PartyCorrectionNotFoundProblemSchema = makeProblemDetailsSchema('PartyCorrectionNotFoundProblem', 404);
export const PartyCorrectionPolicyProblemSchema = makeProblemDetailsSchema('PartyCorrectionPolicyProblem', 422);
export const PartyCorrectionPolicyConflictProblemSchema = makeProblemDetailsSchema(
  'PartyCorrectionPolicyConflictProblem',
  409,
);
export const PartyCorrectionInternalProblemSchema = makeProblemDetailsSchema('PartyCorrectionInternalProblem', 500);
