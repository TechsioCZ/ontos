...
export const ContactsNotFoundProblemSchema = makeProblemDetailsSchema('ContactsNotFoundProblem', 404);
export const ContactsConflictProblemSchema = makeProblemDetailsSchema('ContactsConflictProblem', 409, {
...
export const ContactsUnavailableProblemSchema = makeRetryableProblemDetailsSchema('ContactsUnavailableProblem', 503);
export const ContactsInternalProblemSchema = makeProblemDetailsSchema('ContactsInternalProblem', 500);
...
export const organizationEngagementMutationApi = HttpApi.make('OrganizationEngagementMutationApi').add(
...
const operation = <const Method extends string, const RoutePath extends string>(method: Method, routePath: RoutePath) =>
...
export const engagementProfileOperationContexts = {
  ...
  unarchiveOrganizationEngagement: operation('POST', '/contacts/engagement/organizations/unarchive'),
