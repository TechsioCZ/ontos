...
export const PartyRegistryResourceIdJsonSchema = Schema.toEncoded(
  PartyRegistryResourceIdSchema
);
export const PartyRegistryTenantIdJsonSchema = Schema.toEncoded(
  PartyRegistryTenantIdSchema
);
