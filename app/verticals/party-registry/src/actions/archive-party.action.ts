...
import { ArchivePartyPayloadSchema, ArchivePartyResultSchema } from '../../shared/actions/archive-party.ts';
...
const handle = Effect.fn('ArchivePartyAction.handle')(function* archiveParty(
  ...
  yield* recordPartyInvariantAccess(context, result, 'party-archive-invariants');
