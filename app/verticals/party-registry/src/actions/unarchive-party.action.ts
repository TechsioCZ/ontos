...
const domainEvents = {
  'party.registry.party-unarchived.v1': Schema.Struct({
...
const handle = Effect.fn('UnarchivePartyAction.handle')(
  function* unarchiveParty(
    payload: UnarchivePartyPayload,
    context: ActionHandlerContext<typeof domainEvents, UnarchivePartyServices>
  ) {
    const persistenceResult = yield* context.services.unarchive(
      payload,
