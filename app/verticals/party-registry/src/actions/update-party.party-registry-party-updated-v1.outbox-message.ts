...
import { outboxProducerModuleKey, outboxTopic } from '@app/party-registry/outbox/party-registry-party-updated-v1';
import type { OutboxPayload } from '@app/party-registry/outbox/party-registry-party-updated-v1';

const UpdatePartyPartyRegistryPartyUpdatedV1OutboxProducerModuleKey = outboxProducerModuleKey;
