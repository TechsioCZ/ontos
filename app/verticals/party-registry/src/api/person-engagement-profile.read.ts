...
const personProfileUnavailable = readUnavailable('Contacts engagement persistence is temporarily unavailable');
...
export const personEngagementProfileRead = defineRead(
  {
    ...
    evidencePolicy: {
      ...
      policyKey: 'party.registry.api.person-engagement-profile.evidence.v1',
    },
    ...
    policies: [],
    readKey: 'party.registry.api.person-engagement-profile',
