...
export const organizationEngagementProfiles = contactsSchema.table.withRLS(
  'organization_engagement_profiles',
  {
    engagementProfileId: uuid('engagement_profile_id')
      .defaultRandom()
      .primaryKey(),
  ...
  (table) => [
    ...
    ...tenantRlsPolicies(
      'contacts_organization_engagement_profiles_tenant',
      table.tenantId
    ),
  ]
);
...
export const personEngagementProfiles = contactsSchema.table.withRLS(
  ...
  (table) => [
    ...
    ...tenantRlsPolicies(
      'contacts_person_engagement_profiles_tenant',
      table.tenantId
    ),
  ]
);
...
export const gatewayAssertionRedemptions = contactsSchema.table(
  ...
  (table) => [
    ...
    index('contacts_gateway_assertion_redemptions_expiry_idx').on(
      table.expiresAt
    ),
  ]
);
...
export type PersonEngagementProfileRecord =
  typeof personEngagementProfiles.$inferSelect;
