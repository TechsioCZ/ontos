...
const handleProjectContactPointUpdatedToSearch = Effect.fn(
  'handleProjectContactPointUpdatedToSearch',
...
export const projectContactPointUpdatedToSearchWorker = defineOutboxWorker(
  {
    ...
    topic: outboxTopic,
    workerKey: 'party.registry.project-contact-point-updated-to-search',
  },
  handleProjectContactPointUpdatedToSearch,
);
