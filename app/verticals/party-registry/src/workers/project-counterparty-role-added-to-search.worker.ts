...
const handleProjectCounterpartyRoleAddedToSearch = Effect.fn(
  'handleProjectCounterpartyRoleAddedToSearch',
...
export const projectCounterpartyRoleAddedToSearchWorker = defineOutboxWorker(
  {
    ...
    topic: outboxTopic,
    workerKey: 'party.registry.project-counterparty-role-added-to-search',
  },
  handleProjectCounterpartyRoleAddedToSearch,
);
