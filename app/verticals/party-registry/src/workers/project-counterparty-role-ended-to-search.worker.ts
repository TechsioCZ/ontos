...
// @ontos-outbox-worker-key party.registry.project-counterparty-role-ended-to-search
// @ontos-outbox-worker-owner party.registry
// @ontos-outbox-worker-producer party.registry
// @ontos-outbox-worker-topic party.registry.counterparty-role-ended.v1
...
export const { worker: projectCounterpartyRoleEndedToSearchWorker } = definePartySearchWorker(
  {
    entrypoint: defineTenantModuleEntrypoint({
      access: 'background',
      authorization: { kind: 'owner_local_background' },
      entrypointKey: 'party.registry.project-counterparty-role-ended-to-search',
