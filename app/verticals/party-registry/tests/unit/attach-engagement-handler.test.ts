...
it.effect('engagement creation runs only after successful validation and preserves the result', () =>
...
it.effect('engagement validation failure retains its typed error and prevents persistence', () =>
