...
it.effect('cross-tenant counterparty reads never resolve the persistence service', () =>
...
it.effect('counterparty lookup preserves found values and authorized-context absence', () =>
...
it.effect('counterparty failures preserve the per-read reason and nonenumerable cause', () =>
