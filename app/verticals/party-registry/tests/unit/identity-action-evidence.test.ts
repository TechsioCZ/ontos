...
it.effect('Update Party records metadata-only invariant evidence with its event and outbox', () =>
...
it.effect('Archive Party records metadata-only invariant evidence with its event and outbox', () =>
...
it.effect('Unarchive Party records metadata-only invariant evidence with its event and outbox', () =>
...
it.effect('Unarchive review outcome commits once and replays without an unarchive event or outbox', () =>
