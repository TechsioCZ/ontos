...
export const ReconcilePaymentTermReferencePayloadSchema = Schema.Struct({
  ...
  expectedAliasMetadataRevision: Schema.Finite.check(
    Schema.isInt(),
    Schema.isGreaterThanOrEqualTo(1),
  ),
  expectedCanonicalMetadataRevision: Schema.Finite.check(
    Schema.isInt(),
    Schema.isGreaterThanOrEqualTo(1),
  ),
  reason: PaymentTermReasonSchema,
});
export type ReconcilePaymentTermReferencePayload =
  typeof ReconcilePaymentTermReferencePayloadSchema.Type;
...
export type ReconcilePaymentTermReferenceResult =
  typeof ReconcilePaymentTermReferenceResultSchema.Type;
