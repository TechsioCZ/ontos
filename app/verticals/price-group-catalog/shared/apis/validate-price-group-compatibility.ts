...
// @ontos-public-contract @app/price-group-catalog-contracts/validate-price-group-compatibility
...
export * from '@app/price-group-catalog-contracts/validate-price-group-compatibility';
