...
// @ontos-public-contract @app/price-group-catalog-contracts/price-group-definition/client
...
export * from '@app/price-group-catalog-contracts/price-group-definition/client';
