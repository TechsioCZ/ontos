...
/* eslint-disable curly -- Generated configuration guards are single-statement fail-fast branches. */
import { APP_ENV_PATH } from '@app/core-runtime/workspace-environment';
import { config as loadDotenv } from 'dotenv';
import { defineConfig } from 'drizzle-kit';

const dotenvResult = loadDotenv({ path: APP_ENV_PATH, quiet: true });
...
export default defineConfig({
  ...
  dialect: 'postgresql',
  migrations: { schema: 'drizzle', table: '__drizzle_migrations_projects' },
  out: './drizzle',
