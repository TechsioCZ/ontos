...
export const CustomerForm = ({
  ...
  return (
    <form className="projects:grid projects:min-w-0 projects:gap-6" noValidate onSubmit={submit}>
      <FormInput
      ...
      <div className="projects:grid projects:min-w-0 projects:gap-6 projects:sm:grid-cols-2">
        <FormInput
      ...
      <div className="projects:flex projects:flex-col-reverse projects:gap-3 projects:sm:flex-row projects:sm:justify-end">
        <Button
          disabled={controlsDisabled}
          onClick={onCancel}
          theme="outlined"
