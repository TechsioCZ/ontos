...
export const contactDetailHref = (language: string, customerId: string, contactId: string) =>
  `/${language}/projects/customers/${customerId}/contacts/${contactId}`;
...
export const ContactEditFeature = ({ routeParams, target }: ContactEditPageProps) => {
  ...
  const copy: ContactEditCopy = {
    back: t('projects.pages.contactEdit.back'),
    description: t('projects.pages.contactEdit.description'),
    form: {
      cancel: t('projects.pages.contactEdit.form.cancel'),
      emailInvalid: t('projects.pages.contactEdit.form.emailInvalid'),
      emailLabel: t('projects.pages.contactEdit.form.emailLabel'),
      emailRequired: t('projects.pages.contactEdit.form.emailRequired'),
      nameInvalid: t('projects.pages.contactEdit.form.nameInvalid'),
      nameLabel: t('projects.pages.contactEdit.form.nameLabel'),
      nameRequired: t('projects.pages.contactEdit.form.nameRequired'),
      phoneCountryLabel: t('projects.pages.contactEdit.form.phoneCountryLabel'),
      phoneInvalid: t('projects.pages.contactEdit.form.phoneInvalid'),
      phoneLabel: t('projects.pages.contactEdit.form.phoneLabel'),
      phonePlaceholder: t('projects.pages.contactEdit.form.phonePlaceholder'),
      phoneRequired: t('projects.pages.contactEdit.form.phoneRequired'),
      submit: t('projects.pages.contactEdit.form.submit'),
      submitting: t('projects.pages.contactEdit.form.submitting'),
    },
    mutation: {
      authenticationExpired: t('projects.pages.contactEdit.mutation.authenticationExpired'),
      conflict: t('projects.pages.contactEdit.mutation.conflict'),
      decode: t('projects.pages.contactEdit.mutation.decode'),
      forbidden: t('projects.pages.contactEdit.mutation.forbidden'),
      generic: t('projects.pages.contactEdit.mutation.generic'),
      invalidForm: t('projects.pages.contactEdit.mutation.invalidForm'),
      notFound: t('projects.pages.contactEdit.mutation.notFound'),
      success: t('projects.pages.contactEdit.mutation.success'),
      transport: t('projects.pages.contactEdit.mutation.transport'),
      unavailable: t('projects.pages.contactEdit.mutation.unavailable'),
    },
    states: {
      authenticationExpired: t('projects.pages.contactEdit.states.authenticationExpired'),
      decode: t('projects.pages.contactEdit.states.decode'),
      forbidden: t('projects.pages.contactEdit.states.forbidden'),
      generic: t('projects.pages.contactEdit.states.generic'),
      invalidTarget: t('projects.pages.contactEdit.states.invalidTarget'),
      loading: t('projects.pages.contactEdit.states.loading'),
      notFound: t('projects.pages.contactEdit.states.notFound'),
      readOnly: t('projects.pages.contactEdit.states.readOnly'),
      retry: t('projects.pages.contactEdit.states.retry'),
      retrying: t('projects.pages.contactEdit.states.retrying'),
      transport: t('projects.pages.contactEdit.states.transport'),
      unavailable: t('projects.pages.contactEdit.states.unavailable'),
    },
    title: t('projects.pages.contactEdit.title'),
  };
  ...
  if (detailQuery.isPending) {
    ...
    content = (
      <div className="projects:grid projects:min-w-0 projects:gap-5">
