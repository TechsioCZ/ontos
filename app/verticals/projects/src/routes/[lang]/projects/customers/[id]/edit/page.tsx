...
export const classifyEditCustomerError = (
  ...
  switch (error._tag) {
    ...
    case 'ProjectsConflictProblem': {
      return error.code === 'projects_customer_ico_conflict'
        ? { state: 'ico_conflict' }
        : { state: 'conflict' };
    }
...
export const decodeCustomerEditId = (routeParams: CustomerEditPageRouteParams) => {
  const decoded = Schema.decodeUnknownOption(ProjectsUuidSchema)(routeParams.id);
...
export const CustomerEditFeature = ({ routeParams, target }: CustomerEditPageProps) => {
  ...
  const copy: CustomerEditCopy = {
    back: t('projects.pages.customerEdit.back'),
    description: t('projects.pages.customerEdit.description'),
    form: {
      cancel: t('projects.pages.customerEdit.form.cancel'),
      dicHint: t('projects.pages.customerEdit.form.dicHint'),
      dicInvalid: t('projects.pages.customerEdit.form.dicInvalid'),
      dicLabel: t('projects.pages.customerEdit.form.dicLabel'),
      dissolvedBeforeEstablished: t('projects.pages.customerEdit.form.dissolvedBeforeEstablished'),
      dissolvedOnHint: t('projects.pages.customerEdit.form.dissolvedOnHint'),
      dissolvedOnLabel: t('projects.pages.customerEdit.form.dissolvedOnLabel'),
      establishedOnHint: t('projects.pages.customerEdit.form.establishedOnHint'),
      establishedOnLabel: t('projects.pages.customerEdit.form.establishedOnLabel'),
      icoHint: t('projects.pages.customerEdit.form.icoHint'),
      icoInvalid: t('projects.pages.customerEdit.form.icoInvalid'),
      icoLabel: t('projects.pages.customerEdit.form.icoLabel'),
      legalFormCodeHint: t('projects.pages.customerEdit.form.legalFormCodeHint'),
      legalFormCodeInvalid: t('projects.pages.customerEdit.form.legalFormCodeInvalid'),
      legalFormCodeLabel: t('projects.pages.customerEdit.form.legalFormCodeLabel'),
      nameHint: t('projects.pages.customerEdit.form.nameHint'),
      nameInvalid: t('projects.pages.customerEdit.form.nameInvalid'),
      nameLabel: t('projects.pages.customerEdit.form.nameLabel'),
      nameRequired: t('projects.pages.customerEdit.form.nameRequired'),
      save: t('projects.pages.customerEdit.form.save'),
      saving: t('projects.pages.customerEdit.form.saving'),
    },
    mutation: {
      authenticationExpired: t('projects.pages.customerEdit.mutation.authenticationExpired'),
      conflict: t('projects.pages.customerEdit.mutation.conflict'),
      duplicateIco: t('projects.pages.customerEdit.mutation.duplicateIco'),
      forbidden: t('projects.pages.customerEdit.mutation.forbidden'),
      generic: t('projects.pages.customerEdit.mutation.generic'),
      invalid: t('projects.pages.customerEdit.mutation.invalid'),
      notFound: t('projects.pages.customerEdit.mutation.notFound'),
      success: t('projects.pages.customerEdit.mutation.success'),
    },
    states: {
      authenticationExpired: t('projects.pages.customerEdit.states.authenticationExpired'),
      decode: t('projects.pages.customerEdit.states.decode'),
      forbidden: t('projects.pages.customerEdit.states.forbidden'),
      generic: t('projects.pages.customerEdit.states.generic'),
      loading: t('projects.pages.customerEdit.states.loading'),
      notFound: t('projects.pages.customerEdit.states.notFound'),
      readOnly: t('projects.pages.customerEdit.states.readOnly'),
      retry: t('projects.pages.customerEdit.states.retry'),
      retrying: t('projects.pages.customerEdit.states.retrying'),
      transport: t('projects.pages.customerEdit.states.transport'),
      unavailable: t('projects.pages.customerEdit.states.unavailable'),
    },
    title: t('projects.pages.customerEdit.title'),
  };
  ...
  return (
    ...
    >
      ...
      <header className="projects:grid projects:gap-2">
        <h1 className="projects:text-3xl projects:font-bold" id="customer-edit-heading">
          {copy.title}
        </h1>
