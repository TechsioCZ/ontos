...
export const customerListHref = (language: string) => `/${language}/projects/customers`;
...
export const CustomerCreateFeature = ({ routeParams, target }: CustomerCreatePageProps) => {
  ...
  const copy: CustomerCreateCopy = {
    back: t('projects.pages.customerCreate.back'),
    description: t('projects.pages.customerCreate.description'),
    form: {
      cancel: t('projects.pages.customerCreate.form.cancel'),
      dicHint: t('projects.pages.customerCreate.form.dicHint'),
      dicInvalid: t('projects.pages.customerCreate.form.dicInvalid'),
      dicLabel: t('projects.pages.customerCreate.form.dicLabel'),
      dissolvedBeforeEstablished: t(
        'projects.pages.customerCreate.form.dissolvedBeforeEstablished',
      ),
      dissolvedOnHint: t('projects.pages.customerCreate.form.dissolvedOnHint'),
      dissolvedOnLabel: t('projects.pages.customerCreate.form.dissolvedOnLabel'),
      establishedOnHint: t('projects.pages.customerCreate.form.establishedOnHint'),
      establishedOnLabel: t('projects.pages.customerCreate.form.establishedOnLabel'),
      icoHint: t('projects.pages.customerCreate.form.icoHint'),
      icoInvalid: t('projects.pages.customerCreate.form.icoInvalid'),
      icoLabel: t('projects.pages.customerCreate.form.icoLabel'),
      legalFormCodeHint: t('projects.pages.customerCreate.form.legalFormCodeHint'),
      legalFormCodeInvalid: t('projects.pages.customerCreate.form.legalFormCodeInvalid'),
      legalFormCodeLabel: t('projects.pages.customerCreate.form.legalFormCodeLabel'),
      nameHint: t('projects.pages.customerCreate.form.nameHint'),
      nameInvalid: t('projects.pages.customerCreate.form.nameInvalid'),
      nameLabel: t('projects.pages.customerCreate.form.nameLabel'),
      nameRequired: t('projects.pages.customerCreate.form.nameRequired'),
      save: t('projects.pages.customerCreate.form.save'),
      saving: t('projects.pages.customerCreate.form.saving'),
    },
    lookup: {
      authenticationExpired: t('projects.pages.customerCreate.lookup.authenticationExpired'),
      decode: t('projects.pages.customerCreate.lookup.decode'),
      forbidden: t('projects.pages.customerCreate.lookup.forbidden'),
      formLabel: t('projects.pages.customerCreate.lookup.formLabel'),
      icoInvalid: t('projects.pages.customerCreate.lookup.icoInvalid'),
      icoLabel: t('projects.pages.customerCreate.lookup.icoLabel'),
      internal: t('projects.pages.customerCreate.lookup.internal'),
      lookingUp: t('projects.pages.customerCreate.lookup.lookingUp'),
      lookup: t('projects.pages.customerCreate.lookup.lookup'),
      notFound: t('projects.pages.customerCreate.lookup.notFound'),
      retry: t('projects.pages.customerCreate.lookup.retry'),
      retrying: t('projects.pages.customerCreate.lookup.retrying'),
      success: t('projects.pages.customerCreate.lookup.success'),
      transport: t('projects.pages.customerCreate.lookup.transport'),
      unavailable: t('projects.pages.customerCreate.lookup.unavailable'),
    },
    mutation: {
      authenticationExpired: t('projects.pages.customerCreate.mutation.authenticationExpired'),
      conflict: t('projects.pages.customerCreate.mutation.conflict'),
      forbidden: t('projects.pages.customerCreate.mutation.forbidden'),
      generic: t('projects.pages.customerCreate.mutation.generic'),
      success: t('projects.pages.customerCreate.mutation.success'),
    },
    states: {
      decode: t('projects.pages.customerCreate.states.decode'),
      readOnly: t('projects.pages.customerCreate.states.readOnly'),
      transport: t('projects.pages.customerCreate.states.transport'),
      unavailable: t('projects.pages.customerCreate.states.unavailable'),
    },
    title: t('projects.pages.customerCreate.title'),
  };
  ...
  return (
    ...
    >
      ...
      <header className="projects:grid projects:gap-2">
        <h1 className="projects:text-3xl projects:font-bold" id="customer-create-heading">
          {copy.title}
        </h1>
      ...
      <div
        ...
        className="projects:bg-(--color-surface) projects:p-6 projects:sm:p-8"
      >
        <div className="projects:grid projects:gap-5">
