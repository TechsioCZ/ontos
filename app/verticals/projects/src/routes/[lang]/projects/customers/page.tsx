...
export const customerListQueryKey = ({ offset, status }: CustomerListUrlState) =>
  ['projects', 'customers', 'list', { limit: CUSTOMER_LIST_PAGE_SIZE, offset, status }] as const;
...
export const buildCustomerListHref = (
  ...
  return `/${language}/projects/customers${search.length === 0 ? '' : `?${search}`}`;
};
...
const LoadingCustomerTable = ({ copy }: { readonly copy: CustomersListCopy }) => (
  <div
    ...
    data-testid="customers-table-overflow"
  >
    <Table aria-busy="true" className="projects:min-w-3xl" size="sm" variant="line">
...
export const CustomersListView = ({
  ...
  const createHref = `/${language}/projects/customers/context/new`;
  const statusItems = [
  ...
  return (
    ...
    >
      <div className="projects:grid projects:gap-4 projects:sm:grid-cols-[minmax(0,1fr)_minmax(12rem,18rem)] projects:sm:items-end">
        <div className="projects:flex projects:flex-wrap projects:items-center projects:justify-between projects:gap-3">
          <h1 className="projects:text-3xl projects:font-bold" id="customers-list-heading">
            {copy.tableCaption}
          </h1>
...
const CustomersListFeature = () => {
  ...
  const copy: CustomersListCopy = {
    actionsColumn: t('projects.pages.customersList.table.actions'),
    archive: t('projects.pages.customersList.table.archive'),
    archiving: t('projects.pages.customersList.table.archiving'),
    authenticationExpired: t('projects.pages.customersList.states.authenticationExpired'),
    create: t('projects.pages.customerCreate.title'),
    createdAtColumn: t('projects.pages.customersList.table.createdAt'),
    decode: t('projects.pages.customersList.states.decode'),
    edit: t('projects.pages.customersList.table.edit'),
    empty: t('projects.pages.customersList.states.empty'),
    filterActive: t('projects.pages.customersList.filter.active'),
    filterAll: t('projects.pages.customersList.filter.all'),
    filterArchived: t('projects.pages.customersList.filter.archived'),
    filterLabel: t('projects.pages.customersList.filter.label'),
    filterPlaceholder: t('projects.pages.customersList.filter.placeholder'),
    forbidden: t('projects.pages.customersList.states.forbidden'),
    internal: t('projects.pages.customersList.states.internal'),
    lifecycleAuthenticationExpired: t(
      'projects.pages.customersList.lifecycle.authenticationExpired',
    ),
    lifecycleConflict: t('projects.pages.customersList.lifecycle.conflict'),
    lifecycleForbidden: t('projects.pages.customersList.lifecycle.forbidden'),
    lifecycleInvalid: t('projects.pages.customersList.lifecycle.invalid'),
    lifecycleNotFound: t('projects.pages.customersList.lifecycle.notFound'),
    lifecycleUnavailable: t('projects.pages.customersList.lifecycle.unavailable'),
    lifecycleUnexpected: t('projects.pages.customersList.lifecycle.unexpected'),
    loading: t('projects.pages.customersList.states.loading'),
    nameColumn: t('projects.pages.customersList.table.name'),
    next: t('projects.pages.customersList.pagination.next'),
    paginationLabel: t('projects.pages.customersList.pagination.label'),
    previous: t('projects.pages.customersList.pagination.previous'),
    retry: t('projects.pages.customersList.states.retry'),
    retrying: t('projects.pages.customersList.states.retrying'),
    statusActive: t('projects.pages.customersList.status.active'),
    statusArchived: t('projects.pages.customersList.status.archived'),
    statusColumn: t('projects.pages.customersList.table.status'),
    tableCaption: t('projects.pages.customersList.table.caption'),
    transport: t('projects.pages.customersList.states.transport'),
    unarchive: t('projects.pages.customersList.table.unarchive'),
    unarchiving: t('projects.pages.customersList.table.unarchiving'),
    unavailable: t('projects.pages.customersList.states.unavailable'),
    updatedAtColumn: t('projects.pages.customersList.table.updatedAt'),
  };
  ...
  if (query.isPending) {
    ...
    view = {
      items: query.data.items.map((customer) => {
        const detailHref = `/${language}/projects/customers/${encodeURIComponent(customer.customerId)}`;
        return {
