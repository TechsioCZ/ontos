...
} from '../../src/routes/[lang]/projects/customers/page.tsx';
...
const translations = {
  cs: {
    'projects.pages.customerCreate.title': 'Vytvořit zákazníka',
    'projects.pages.customerEdit.title': 'Upravit zákazníka',
    'projects.pages.customersList.filter.active': 'Aktivní',
    'projects.pages.customersList.filter.all': 'Všichni',
    'projects.pages.customersList.filter.archived': 'Archivovaní',
    'projects.pages.customersList.filter.label': 'Stav zákazníka',
    'projects.pages.customersList.filter.placeholder': 'Vyberte stav',
    'projects.pages.customersList.lifecycle.authenticationExpired': 'Relace vypršela.',
    'projects.pages.customersList.lifecycle.conflict': 'Stav se změnil.',
    'projects.pages.customersList.lifecycle.forbidden': 'Změna není povolena.',
    'projects.pages.customersList.lifecycle.invalid': 'Požadavek není platný.',
    'projects.pages.customersList.lifecycle.notFound': 'Zákazník nebyl nalezen.',
    'projects.pages.customersList.lifecycle.unavailable': 'Změna není dostupná.',
    'projects.pages.customersList.lifecycle.unexpected': 'Změna se nezdařila.',
    'projects.pages.customersList.pagination.label': 'Stránky seznamu zákazníků',
    'projects.pages.customersList.pagination.next': 'Další',
    'projects.pages.customersList.pagination.previous': 'Předchozí',
    'projects.pages.customersList.states.authenticationExpired':
      'Vaše relace vypršela. Po přihlášení to zkuste znovu.',
    'projects.pages.customersList.states.decode':
      'Odpověď se seznamem zákazníků se nepodařilo přečíst. Zkuste to znovu.',
    'projects.pages.customersList.states.empty': 'Tomuto filtru neodpovídají žádní zákazníci.',
    'projects.pages.customersList.states.forbidden': 'Nemáte oprávnění zobrazit zákazníky.',
    'projects.pages.customersList.states.internal':
      'Seznam zákazníků se nepodařilo bezpečně načíst. Zkuste to znovu.',
    'projects.pages.customersList.states.loading': 'Načítání zákazníků…',
    'projects.pages.customersList.states.retry': 'Zkusit znovu',
    'projects.pages.customersList.states.retrying': 'Opakování…',
    'projects.pages.customersList.states.transport':
      'Seznam zákazníků není dostupný. Zkontrolujte připojení a zkuste to znovu.',
    'projects.pages.customersList.states.unavailable':
      'Seznam zákazníků je dočasně nedostupný. Zkuste to znovu.',
    'projects.pages.customersList.status.active': 'Aktivní',
    'projects.pages.customersList.status.archived': 'Archivovaný',
    'projects.pages.customersList.table.actions': 'Akce',
    'projects.pages.customersList.table.archive': 'Archivovat',
    'projects.pages.customersList.table.archiving': 'Archivace…',
    'projects.pages.customersList.table.caption': 'Zákazníci',
    'projects.pages.customersList.table.createdAt': 'Vytvořeno',
    'projects.pages.customersList.table.edit': 'Upravit',
    'projects.pages.customersList.table.name': 'Jméno zákazníka',
    'projects.pages.customersList.table.status': 'Stav',
    'projects.pages.customersList.table.unarchive': 'Odarchivovat',
    'projects.pages.customersList.table.unarchiving': 'Ruším archivaci…',
    'projects.pages.customersList.table.updatedAt': 'Aktualizováno',
  },
  en: {
    'projects.pages.customerCreate.title': 'Create Customer',
    'projects.pages.customerEdit.title': 'Edit Customer',
    'projects.pages.customersList.filter.active': 'Active',
    'projects.pages.customersList.filter.all': 'All',
    'projects.pages.customersList.filter.archived': 'Archived',
    'projects.pages.customersList.filter.label': 'Customer status',
    'projects.pages.customersList.filter.placeholder': 'Choose a status',
    'projects.pages.customersList.lifecycle.authenticationExpired': 'Your session expired.',
    'projects.pages.customersList.lifecycle.conflict': 'The status changed.',
    'projects.pages.customersList.lifecycle.forbidden': 'The change is forbidden.',
    'projects.pages.customersList.lifecycle.invalid': 'The request is invalid.',
    'projects.pages.customersList.lifecycle.notFound': 'The Customer was not found.',
    'projects.pages.customersList.lifecycle.unavailable': 'The change is unavailable.',
    'projects.pages.customersList.lifecycle.unexpected': 'The change failed.',
    'projects.pages.customersList.pagination.label': 'Customer list pages',
    'projects.pages.customersList.pagination.next': 'Next',
    'projects.pages.customersList.pagination.previous': 'Previous',
    'projects.pages.customersList.states.authenticationExpired':
      'Your session has expired. Try again after signing in.',
    'projects.pages.customersList.states.decode':
      'The Customer list response could not be read. Try again.',
    'projects.pages.customersList.states.empty': 'No Customers match this filter.',
    'projects.pages.customersList.states.forbidden':
      'You do not have permission to view Customers.',
    'projects.pages.customersList.states.internal':
      'The Customer list could not be loaded safely. Try again.',
    'projects.pages.customersList.states.loading': 'Loading Customers…',
    'projects.pages.customersList.states.retry': 'Try again',
    'projects.pages.customersList.states.retrying': 'Trying again…',
    'projects.pages.customersList.states.transport':
    ...
    'projects.pages.customersList.status.active': 'Active',
    'projects.pages.customersList.status.archived': 'Archived',
    'projects.pages.customersList.table.actions': 'Actions',
    'projects.pages.customersList.table.archive': 'Archive',
    'projects.pages.customersList.table.archiving': 'Archiving…',
    'projects.pages.customersList.table.caption': 'Customers',
    'projects.pages.customersList.table.createdAt': 'Created',
    'projects.pages.customersList.table.edit': 'Edit',
    'projects.pages.customersList.table.name': 'Customer name',
    'projects.pages.customersList.table.status': 'Status',
    'projects.pages.customersList.table.unarchive': 'Unarchive',
    'projects.pages.customersList.table.unarchiving': 'Unarchiving…',
    'projects.pages.customersList.table.updatedAt': 'Updated',
  },
} as const;
...
describe('Customer list URL state', () => {
  ...
  test('builds a stable query key and localized links while retaining unrelated query state', () => {
    ...
    expect(buildCustomerListHref('en', '?view=compact&status=all&offset=50', 'active', 0)).toBe(
      '/en/projects/customers?view=compact&status=active',
    );
  });
});

test('loads the initial page once through the typed Projects client with the exact bounded payload', async () => {
...
test('renders semantic Customer values, ordered rows, localized dates, badges, and honest links', async () => {
  ...
  ).toBe(`/en/projects/customers/${activeCustomer.customerId}`);
  ...
  expect(screen.getByRole('link', { name: 'Previous' }).getAttribute('href')).toBe(
    '/en/projects/customers?view=compact&status=all',
  );
  expect(screen.getByRole('link', { name: 'Next' }).getAttribute('href')).toBe(
    '/en/projects/customers?view=compact&status=all&offset=50',
  );
});
...
test('shows the empty Customer table without data rows or a pager', async () => {
  ...
  expect(screen.getByRole('link', { name: 'Create Customer' }).getAttribute('href')).toBe(
    '/en/projects/customers/context/new',
  );
...
test('changes the status filter by keyboard, retains safe query state, and resets the offset', async () => {
  ...
  expect(navigateMock).toHaveBeenCalledWith({
    to: '/en/projects/customers?view=compact&status=archived',
  });
});
...
test('renders Czech-owned heading, filter, status, dates, errors, retry, and navigation copy', async () => {
  ...
  expect(screen.getByRole('link', { name: 'Vytvořit zákazníka' }).getAttribute('href')).toBe(
    '/cs/projects/customers/context/new',
  );
...
test('owns the UI-kit token, theme, class source, and local overflow boundary', async () => {
  ...
  expect(appCss).toContain("@import 'tailwindcss' prefix(projects) source(none);");
...
test('keeps English and Czech Customer-list locale structures in parity', () => {
  expect(flattenKeys(csCatalog.projects.pages.customersList)).toEqual(
    flattenKeys(enCatalog.projects.pages.customersList),
  );
});
