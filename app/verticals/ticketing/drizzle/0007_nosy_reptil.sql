...
ALTER TABLE "ticketing"."task_id_assignments" ADD CONSTRAINT "task_id_assignments_task_id_tasks_task_id_fk" FOREIGN KEY ("task_id") REFERENCES "ticketing"."tasks"("task_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
