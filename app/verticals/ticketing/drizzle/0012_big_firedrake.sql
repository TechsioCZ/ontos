CREATE TABLE "ticketing"."task_email_values" (
	...
	CONSTRAINT "ticketing_task_email_values_normalized_ck" CHECK (("ticketing"."task_email_values"."normalized_value" is null and "ticketing"."task_email_values"."value" is null) or "ticketing"."task_email_values"."normalized_value" = lower("ticketing"."task_email_values"."value")),
...
ALTER TABLE "ticketing"."task_property_definitions" ADD CONSTRAINT "ticketing_task_property_definitions_datatype_ck" CHECK ("ticketing"."task_property_definitions"."datatype" in ('title', 'checkbox', 'email', 'number', 'select', 'text', 'url'));--> statement-breakpoint
ALTER TABLE "ticketing"."task_revisions" ADD CONSTRAINT "ticketing_task_revisions_reason_ck" CHECK ("ticketing"."task_revisions"."reason" in ('created', 'checkbox_value_changed', 'email_value_changed', 'number_value_changed', 'select_value_changed', 'text_value_changed', 'url_value_changed', 'archived', 'restored', 'soft_deleted'));