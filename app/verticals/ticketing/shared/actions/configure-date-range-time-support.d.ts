...
export declare const configureDateRangeTimeSupportActionFailureSchemas: readonly [
  Schema.Struct<{
...
export declare const configureDateRangeTimeSupportActionFailureSchema: Schema.Union<
  readonly [
    Schema.Struct<{
      readonly code: Schema.optional<Schema.String>;
      readonly httpStatus: Schema.Finite;
