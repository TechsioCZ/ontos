...
export declare const configureIdPropertyPrefixActionKey: 'ticketing.configureIdPropertyPrefix';
export declare const configureIdPropertyPrefixActionPayloadSchema: Schema.Struct<{
    readonly collectionId: Schema.String;
    readonly expectedRevision: Schema.Finite;
    readonly prefix: Schema.String;
    readonly propertyDefinitionId: Schema.String;
}>;
export declare const configureIdPropertyPrefixActionHeadersSchema: Schema.Struct<{
    readonly 'Idempotency-Key': Schema.optional<Schema.String>;
    readonly 'x-ontos-operation-context': Schema.optional<Schema.String>;
}>;
export declare const configureIdPropertyPrefixActionResponseSchema: Schema.Struct<{
...
export declare const configureIdPropertyPrefixActionOutcomeSchema: Schema.Struct<{
...
export declare const configureIdPropertyPrefixActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
...
export declare const configureIdPropertyPrefixActionFailureSchemas: readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type ConfigureIdPropertyPrefixActionPayload = typeof configureIdPropertyPrefixActionPayloadSchema.Type;
export interface ConfigureIdPropertyPrefixActionResponse {
    readonly definition: IdPropertyDefinition;
}
export type ConfigureIdPropertyPrefixActionOutcome = typeof configureIdPropertyPrefixActionOutcomeSchema.Type;
export type ConfigureIdPropertyPrefixActionFailure = typeof configureIdPropertyPrefixActionFailureSchema.Type;
export declare const configureIdPropertyPrefixActionTitle: 'Configure ID Property Prefix';
