...
export declare const configureIdPropertyPrefixActionFailureSchema: Schema.Union<
  readonly [
    Schema.Struct<{
...
>;
export declare const configureIdPropertyPrefixActionFailureSchemas: readonly [
  Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
