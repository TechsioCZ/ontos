...
export declare const configurePersonPropertyCardinalityActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const configurePersonPropertyCardinalityActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type ConfigurePersonPropertyCardinalityActionPayload = typeof configurePersonPropertyCardinalityActionPayloadSchema.Type;
export type ConfigurePersonPropertyCardinalityActionResponse = typeof configurePersonPropertyCardinalityActionResponseSchema.Type;
export type ConfigurePersonPropertyCardinalityActionOutcome = typeof configurePersonPropertyCardinalityActionOutcomeSchema.Type;
export type ConfigurePersonPropertyCardinalityActionFailure = typeof configurePersonPropertyCardinalityActionFailureSchema.Type;
