...
export declare const configurePrincipalTimeZonePreferenceActionFailureSchemas: readonly [
  Schema.Struct<{
...
export declare const configurePrincipalTimeZonePreferenceActionFailureSchema: Schema.Union<
  readonly [
    Schema.Struct<{
      readonly code: Schema.optional<Schema.String>;
      readonly httpStatus: Schema.Finite;
