...
export declare const configureSelectOptionOrderActionFailureSchemas: readonly [
  Schema.Struct<{
...
export declare const configureSelectOptionOrderActionFailureSchema: Schema.Union<
  readonly [
    Schema.Struct<{
      readonly code: Schema.optional<Schema.String>;
      readonly httpStatus: Schema.Finite;
