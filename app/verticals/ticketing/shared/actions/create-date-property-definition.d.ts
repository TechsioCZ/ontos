...
export declare const createDatePropertyDefinitionActionKey: 'ticketing.createDatePropertyDefinition';
export declare const createDatePropertyDefinitionActionPayloadSchema: Schema.Struct<{
  readonly collectionId: Schema.String;
  readonly mandatory: Schema.Boolean;
  readonly name: Schema.String;
}>;
export declare const createDatePropertyDefinitionActionHeadersSchema: Schema.Struct<{
  readonly 'Idempotency-Key': Schema.optional<Schema.String>;
  readonly 'x-ontos-operation-context': Schema.optional<Schema.String>;
}>;
export declare const createDatePropertyDefinitionActionResponseSchema: Schema.Struct<{
...
export declare const createDatePropertyDefinitionActionOutcomeSchema: Schema.Struct<{
...
export declare const createDatePropertyDefinitionActionFailureSchemas: readonly [
  Schema.Struct<{
...
export declare const createDatePropertyDefinitionActionFailureSchema: Schema.Union<
  readonly [
    Schema.Struct<{
      readonly code: Schema.optional<Schema.String>;
      readonly httpStatus: Schema.Finite;
...
export declare const createDatePropertyDefinitionActionTitle: 'Create Date Property Definition';
