...
export declare const createDateRangePropertyDefinitionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const createDateRangePropertyDefinitionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type CreateDateRangePropertyDefinitionActionPayload = typeof createDateRangePropertyDefinitionActionPayloadSchema.Type;
export type CreateDateRangePropertyDefinitionActionResponse = typeof createDateRangePropertyDefinitionActionResponseSchema.Type;
export type CreateDateRangePropertyDefinitionActionOutcome = typeof createDateRangePropertyDefinitionActionOutcomeSchema.Type;
export type CreateDateRangePropertyDefinitionActionFailure = typeof createDateRangePropertyDefinitionActionFailureSchema.Type;
