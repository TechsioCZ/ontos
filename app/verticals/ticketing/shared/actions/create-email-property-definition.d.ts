...
export declare const createEmailPropertyDefinitionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const createEmailPropertyDefinitionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type CreateEmailPropertyDefinitionActionPayload = typeof createEmailPropertyDefinitionActionPayloadSchema.Type;
export type CreateEmailPropertyDefinitionActionResponse = typeof createEmailPropertyDefinitionActionResponseSchema.Type;
export type CreateEmailPropertyDefinitionActionOutcome = typeof createEmailPropertyDefinitionActionOutcomeSchema.Type;
export type CreateEmailPropertyDefinitionActionFailure = typeof createEmailPropertyDefinitionActionFailureSchema.Type;
