...
export declare const createFilesMediaPropertyDefinitionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const createFilesMediaPropertyDefinitionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type CreateFilesMediaPropertyDefinitionActionPayload = typeof createFilesMediaPropertyDefinitionActionPayloadSchema.Type;
export type CreateFilesMediaPropertyDefinitionActionResponse = typeof createFilesMediaPropertyDefinitionActionResponseSchema.Type;
export type CreateFilesMediaPropertyDefinitionActionOutcome = typeof createFilesMediaPropertyDefinitionActionOutcomeSchema.Type;
export type CreateFilesMediaPropertyDefinitionActionFailure = typeof createFilesMediaPropertyDefinitionActionFailureSchema.Type;
