...
export declare const createIdPropertyDefinitionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
...
export declare const createIdPropertyDefinitionActionFailureSchemas: readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type CreateIdPropertyDefinitionActionPayload = typeof createIdPropertyDefinitionActionPayloadSchema.Type;
export interface CreateIdPropertyDefinitionActionResponse {
    readonly definition: IdPropertyDefinition;
}
export type CreateIdPropertyDefinitionActionOutcome = typeof createIdPropertyDefinitionActionOutcomeSchema.Type;
export type CreateIdPropertyDefinitionActionFailure = typeof createIdPropertyDefinitionActionFailureSchema.Type;
