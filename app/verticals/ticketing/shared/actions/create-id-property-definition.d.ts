...
export declare const createIdPropertyDefinitionActionKey: 'ticketing.createIdPropertyDefinition';
export declare const createIdPropertyDefinitionActionPayloadSchema: Schema.Struct<{
  readonly collectionId: Schema.String;
  readonly mandatory: Schema.Boolean;
  readonly name: Schema.String;
  readonly prefix: Schema.String;
}>;
export declare const createIdPropertyDefinitionActionHeadersSchema: Schema.Struct<{
  readonly 'Idempotency-Key': Schema.optional<Schema.String>;
  readonly 'x-ontos-operation-context': Schema.optional<Schema.String>;
}>;
export declare const createIdPropertyDefinitionActionResponseSchema: Schema.Struct<{
...
export declare const createIdPropertyDefinitionActionOutcomeSchema: Schema.Struct<{
...
export declare const createIdPropertyDefinitionActionFailureSchema: Schema.Union<
  readonly [
    Schema.Struct<{
...
>;
export declare const createIdPropertyDefinitionActionFailureSchemas: readonly [
  Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
...
export declare const createIdPropertyDefinitionActionTitle: 'Create ID Property Definition';
