...
export declare const createIntrinsicPropertyDefinitionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const createIntrinsicPropertyDefinitionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type CreateIntrinsicPropertyDefinitionActionPayload = typeof createIntrinsicPropertyDefinitionActionPayloadSchema.Type;
export type CreateIntrinsicPropertyDefinitionActionResponse = typeof createIntrinsicPropertyDefinitionActionResponseSchema.Type;
export type CreateIntrinsicPropertyDefinitionActionOutcome = typeof createIntrinsicPropertyDefinitionActionOutcomeSchema.Type;
export type CreateIntrinsicPropertyDefinitionActionFailure = typeof createIntrinsicPropertyDefinitionActionFailureSchema.Type;
