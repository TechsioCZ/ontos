...
export declare const createStatusPropertyDefinitionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const createStatusPropertyDefinitionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type CreateStatusPropertyDefinitionActionPayload = typeof createStatusPropertyDefinitionActionPayloadSchema.Type;
export type CreateStatusPropertyDefinitionActionResponse = typeof createStatusPropertyDefinitionActionResponseSchema.Type;
export type CreateStatusPropertyDefinitionActionOutcome = typeof createStatusPropertyDefinitionActionOutcomeSchema.Type;
export type CreateStatusPropertyDefinitionActionFailure = typeof createStatusPropertyDefinitionActionFailureSchema.Type;
