...
export declare const createTaskCollectionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
...
export declare const createTaskCollectionActionFailureSchemas: readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
