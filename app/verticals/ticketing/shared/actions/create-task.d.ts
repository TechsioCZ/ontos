...
export declare const createTaskActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
...
export declare const createTaskActionFailureSchemas: readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
