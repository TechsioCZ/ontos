...
export declare const createTextPropertyDefinitionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const createTextPropertyDefinitionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type CreateTextPropertyDefinitionActionPayload = typeof createTextPropertyDefinitionActionPayloadSchema.Type;
export type CreateTextPropertyDefinitionActionResponse = typeof createTextPropertyDefinitionActionResponseSchema.Type;
export type CreateTextPropertyDefinitionActionOutcome = typeof createTextPropertyDefinitionActionOutcomeSchema.Type;
export type CreateTextPropertyDefinitionActionFailure = typeof createTextPropertyDefinitionActionFailureSchema.Type;
