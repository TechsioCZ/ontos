...
export declare const deleteMultiSelectOptionActionKey: 'ticketing.deleteMultiSelectOption';
export declare const deleteMultiSelectOptionActionPayloadSchema: Schema.Struct<{
...
export declare const deleteMultiSelectOptionActionHeadersSchema: Schema.Struct<{
    readonly 'Idempotency-Key': Schema.optional<Schema.String>;
    readonly 'x-ontos-operation-context': Schema.optional<Schema.String>;
}>;
export declare const deleteMultiSelectOptionActionResponseSchema: Schema.Struct<{
    readonly definitionRevision: Schema.Finite;
    readonly deletedOptionId: Schema.String;
    readonly impactCount: Schema.Finite;
    readonly propertyDefinitionId: Schema.String;
}>;
export declare const deleteMultiSelectOptionActionOutcomeSchema: Schema.Struct<{
...
export declare const deleteMultiSelectOptionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const deleteMultiSelectOptionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type DeleteMultiSelectOptionActionPayload = typeof deleteMultiSelectOptionActionPayloadSchema.Type;
export type DeleteMultiSelectOptionActionResponse = typeof deleteMultiSelectOptionActionResponseSchema.Type;
export type DeleteMultiSelectOptionActionOutcome = typeof deleteMultiSelectOptionActionOutcomeSchema.Type;
export type DeleteMultiSelectOptionActionFailure = typeof deleteMultiSelectOptionActionFailureSchema.Type;
export declare const deleteMultiSelectOptionActionTitle: 'Delete Multi-select Option';
