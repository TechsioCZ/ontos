...
export declare const deleteSelectOptionActionKey: 'ticketing.deleteSelectOption';
export declare const deleteSelectOptionActionPayloadSchema: Schema.Struct<{
...
export declare const deleteSelectOptionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const deleteSelectOptionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export declare const deleteSelectOptionActionTitle: 'Delete Select Option';
