...
export declare const deleteStatusOptionActionKey: 'ticketing.deleteStatusOption';
export declare const deleteStatusOptionActionPayloadSchema: Schema.Struct<{
...
export declare const deleteStatusOptionActionHeadersSchema: Schema.Struct<{
    readonly 'Idempotency-Key': Schema.optional<Schema.String>;
    readonly 'x-ontos-operation-context': Schema.optional<Schema.String>;
}>;
export declare const deleteStatusOptionActionResponseSchema: Schema.Struct<{
...
export declare const deleteStatusOptionActionOutcomeSchema: Schema.Struct<{
...
export declare const deleteStatusOptionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const deleteStatusOptionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export declare const deleteStatusOptionActionTitle: 'Delete Status Option';
