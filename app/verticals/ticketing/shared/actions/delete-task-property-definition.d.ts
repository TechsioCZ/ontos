...
export declare const deleteTaskPropertyDefinitionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const deleteTaskPropertyDefinitionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type DeleteTaskPropertyDefinitionActionPayload = typeof deleteTaskPropertyDefinitionActionPayloadSchema.Type;
export type DeleteTaskPropertyDefinitionActionResponse = typeof deleteTaskPropertyDefinitionActionResponseSchema.Type;
export type DeleteTaskPropertyDefinitionActionOutcome = typeof deleteTaskPropertyDefinitionActionOutcomeSchema.Type;
export type DeleteTaskPropertyDefinitionActionFailure = typeof deleteTaskPropertyDefinitionActionFailureSchema.Type;
