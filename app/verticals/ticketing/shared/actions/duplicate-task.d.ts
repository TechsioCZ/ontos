...
export declare const duplicateTaskActionKey: 'ticketing.duplicateTask';
export declare const duplicateTaskActionPayloadSchema: Schema.Struct<{
  readonly collectionId: Schema.String;
  readonly sourceTaskId: Schema.String;
}>;
export declare const duplicateTaskActionHeadersSchema: Schema.Struct<{
  readonly 'Idempotency-Key': Schema.optional<Schema.String>;
  readonly 'x-ontos-operation-context': Schema.optional<Schema.String>;
}>;
export declare const duplicateTaskActionResponseSchema: Schema.Struct<{
...
export declare const duplicateTaskActionOutcomeSchema: Schema.Struct<{
...
export declare const duplicateTaskActionFailureSchema: Schema.Union<
  readonly [
    Schema.Struct<{
...
>;
export declare const duplicateTaskActionFailureSchemas: readonly [
  Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
...
export declare const duplicateTaskActionTitle: 'Duplicate Task';
