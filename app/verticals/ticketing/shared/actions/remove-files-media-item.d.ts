...
export declare const removeFilesMediaItemActionKey: 'ticketing.removeFilesMediaItem';
export declare const removeFilesMediaItemActionPayloadSchema: Schema.Struct<{
...
export declare const removeFilesMediaItemActionHeadersSchema: Schema.Struct<{
    readonly 'Idempotency-Key': Schema.optional<Schema.String>;
    readonly 'x-ontos-operation-context': Schema.optional<Schema.String>;
}>;
export declare const removeFilesMediaItemActionResponseSchema: Schema.Struct<{
    readonly removedItemId: Schema.String;
    readonly taskRevision: Schema.Finite;
}>;
export declare const removeFilesMediaItemActionOutcomeSchema: Schema.Struct<{
...
export declare const removeFilesMediaItemActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const removeFilesMediaItemActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type RemoveFilesMediaItemActionResponse = typeof removeFilesMediaItemActionResponseSchema.Type;
...
export declare const removeFilesMediaItemActionTitle: 'Remove Files & media item';
