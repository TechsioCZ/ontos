...
export declare const taskRetentionStateSchema: Schema.Literals<readonly ["active", "archived", "softDeleted"]>;
...
export declare const transitionTaskRetentionActionResponseSchema: Schema.Union<readonly [Schema.Struct<{
    readonly retentionState: Schema.Literals<readonly ["active", "archived", "softDeleted"]>;
    readonly taskId: Schema.String;
    readonly taskRevision: Schema.Finite;
}>, Schema.Struct<{
...
export declare const transitionTaskRetentionActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const transitionTaskRetentionActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type TransitionTaskRetentionActionPayload = typeof transitionTaskRetentionActionPayloadSchema.Type;
export type TransitionTaskRetentionActionResponse = typeof transitionTaskRetentionActionResponseSchema.Type;
export type TransitionTaskRetentionActionOutcome = typeof transitionTaskRetentionActionOutcomeSchema.Type;
export type TransitionTaskRetentionActionFailure = typeof transitionTaskRetentionActionFailureSchema.Type;
