...
export declare const updateDateRangePropertyValueActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const updateDateRangePropertyValueActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type UpdateDateRangePropertyValueActionPayload = typeof updateDateRangePropertyValueActionPayloadSchema.Type;
export type UpdateDateRangePropertyValueActionResponse = typeof updateDateRangePropertyValueActionResponseSchema.Type;
export type UpdateDateRangePropertyValueActionOutcome = typeof updateDateRangePropertyValueActionOutcomeSchema.Type;
export type UpdateDateRangePropertyValueActionFailure = typeof updateDateRangePropertyValueActionFailureSchema.Type;
