...
export declare const updateEmailPropertyValueActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const updateEmailPropertyValueActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type UpdateEmailPropertyValueActionPayload = typeof updateEmailPropertyValueActionPayloadSchema.Type;
export type UpdateEmailPropertyValueActionResponse = typeof updateEmailPropertyValueActionResponseSchema.Type;
export type UpdateEmailPropertyValueActionOutcome = typeof updateEmailPropertyValueActionOutcomeSchema.Type;
export type UpdateEmailPropertyValueActionFailure = typeof updateEmailPropertyValueActionFailureSchema.Type;
