...
export declare const updatePersonPropertyValueActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const updatePersonPropertyValueActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type UpdatePersonPropertyValueActionPayload = typeof updatePersonPropertyValueActionPayloadSchema.Type;
export type UpdatePersonPropertyValueActionResponse = typeof updatePersonPropertyValueActionResponseSchema.Type;
export type UpdatePersonPropertyValueActionOutcome = typeof updatePersonPropertyValueActionOutcomeSchema.Type;
export type UpdatePersonPropertyValueActionFailure = typeof updatePersonPropertyValueActionFailureSchema.Type;
