...
export declare const updateSelectPropertyValueActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const updateSelectPropertyValueActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type UpdateSelectPropertyValueActionPayload = typeof updateSelectPropertyValueActionPayloadSchema.Type;
export type UpdateSelectPropertyValueActionResponse = typeof updateSelectPropertyValueActionResponseSchema.Type;
export type UpdateSelectPropertyValueActionOutcome = typeof updateSelectPropertyValueActionOutcomeSchema.Type;
export type UpdateSelectPropertyValueActionFailure = typeof updateSelectPropertyValueActionFailureSchema.Type;
