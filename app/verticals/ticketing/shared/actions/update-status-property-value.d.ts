...
export declare const updateStatusPropertyValueActionKey: 'ticketing.updateStatusPropertyValue';
export declare const updateStatusPropertyValueActionPayloadSchema: Schema.Struct<{
...
export declare const updateStatusPropertyValueActionHeadersSchema: Schema.Struct<{
  readonly 'Idempotency-Key': Schema.optional<Schema.String>;
  readonly 'x-ontos-operation-context': Schema.optional<Schema.String>;
}>;
export declare const updateStatusPropertyValueActionResponseSchema: Schema.Struct<{
...
export declare const updateStatusPropertyValueActionOutcomeSchema: Schema.Struct<{
...
export declare const updateStatusPropertyValueActionFailureSchemas: readonly [
  Schema.Struct<{
...
export declare const updateStatusPropertyValueActionFailureSchema: Schema.Union<
  readonly [
    Schema.Struct<{
      readonly code: Schema.optional<Schema.String>;
      readonly httpStatus: Schema.Finite;
...
export declare const updateStatusPropertyValueActionTitle: 'Update Status Property Value';
