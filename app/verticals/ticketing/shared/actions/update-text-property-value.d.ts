...
export declare const updateTextPropertyValueActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const updateTextPropertyValueActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type UpdateTextPropertyValueActionPayload = typeof updateTextPropertyValueActionPayloadSchema.Type;
export type UpdateTextPropertyValueActionResponse = typeof updateTextPropertyValueActionResponseSchema.Type;
export type UpdateTextPropertyValueActionOutcome = typeof updateTextPropertyValueActionOutcomeSchema.Type;
export type UpdateTextPropertyValueActionFailure = typeof updateTextPropertyValueActionFailureSchema.Type;
