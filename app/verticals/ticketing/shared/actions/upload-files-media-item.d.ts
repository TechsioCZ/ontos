...
export declare const uploadedFilesMediaItemSchema: Schema.Struct<{
...
export declare const externalFilesMediaItemSchema: Schema.Struct<{
...
export declare const filesMediaItemSchema: Schema.Union<readonly [Schema.Struct<{
    readonly access: Schema.Literal<"download">;
    readonly byteSize: Schema.Finite;
    readonly displayFilename: Schema.String;
    readonly effectiveMimeType: Schema.String;
...
export declare const uploadFilesMediaItemActionFailureSchemas: readonly [Schema.Struct<{
...
export declare const uploadFilesMediaItemActionFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
...
export type UploadFilesMediaItemActionResponse = typeof uploadFilesMediaItemActionResponseSchema.Type;
