...
export declare const filesMediaUploadOutcomeSchema: Schema.Union<
  readonly [
    Schema.Struct<{
...
export declare const uploadFilesMediaItemsActionResponseSchema: Schema.Struct<{
  readonly outcomes: Schema.$Array<
    Schema.Union<
      readonly [
        Schema.Struct<{
          readonly item: Schema.Struct<{
...
export declare const uploadFilesMediaItemsActionFailureSchemas: readonly [
  Schema.Struct<{
...
export declare const uploadFilesMediaItemsActionFailureSchema: Schema.Union<
  readonly [
    Schema.Struct<{
      readonly code: Schema.optional<Schema.String>;
      readonly httpStatus: Schema.Finite;
