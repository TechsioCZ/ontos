...
export declare const coreSdkOperationFailureSchemas: readonly [Schema.Struct<{
...
export declare const coreSdkOperationFailureSchema: Schema.Union<readonly [Schema.Struct<{
    readonly code: Schema.optional<Schema.String>;
    readonly httpStatus: Schema.Finite;
    readonly message: Schema.String;
    readonly ok: Schema.Literal<false>;
