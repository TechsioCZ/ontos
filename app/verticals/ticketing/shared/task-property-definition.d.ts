...
export declare const multiSelectOptionSchema: Schema.Struct<{
...
export declare const multiSelectPropertyDefinitionSchema: Schema.Struct<{
...
export declare const statusGroupKeySchema: Schema.Literals<readonly ["todo", "in_progress", "complete"]>;
