...
export declare const textMarkSchema: Schema.Union<readonly [Schema.Struct<{
...
export declare const textInlineNodeSchema: Schema.Union<readonly [Schema.Struct<{
...
export declare const nullableTextDocumentSchema: Schema.Union<readonly [Schema.Null, Schema.Struct<{
    readonly content: Schema.$Array<Schema.Union<readonly [Schema.Struct<{
        readonly marks: Schema.$Array<Schema.Union<readonly [Schema.Struct<{
            readonly type: Schema.Literals<readonly ["bold", "italic", "underline", "strikethrough", "code"]>;
        }>, Schema.Struct<{
