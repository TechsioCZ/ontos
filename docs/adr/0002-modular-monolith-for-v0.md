...
Status: Superseded by [ADR-0016](0016-independently-deployable-microverticals.md). Co-location remains allowed as Deployment Topology, but it is not a module-interface constraint.
