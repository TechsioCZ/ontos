...
This ADR governs staff authentication in the OntOS Shell and Commerce Operations. Commerce Portal Accounts use a separate Commerce-owned BetterAuth realm, cookies, sessions, and lifecycle under [ADR-0017](0017-commerce-application-boundaries.md); they do not become staff accounts or inherit staff Tenant-selection semantics.
