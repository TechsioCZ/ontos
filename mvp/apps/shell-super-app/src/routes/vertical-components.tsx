...
import {
  ...
  findPublicComponentDescriptor,
} from '../verticals/public-components.tsx';
...
const widgetCount = Number(propertyUnitCard === undefined ? '0' : '1');
      ...
      <div className="shell:grid shell:gap-4 shell:md:grid-cols-2">
        {propertyUnitCard === undefined ? undefined : (
          <FederatedPublicComponent
            ...
            fallback={<p>{t('shell.hero.empty')}</p>}
            props={{
              displayName: 'Shell view of Unit A-101',
              source: 'shell',
              unitId: 'unit-a-101',
            }}
          />
